var PromotionsMixin = { created: function() { console.log('created PromotionsMixin'); }, methods: { createPromotion: function(type, name, config, design, prizes, callback) { $.ajax({ method: "POST", dataType: "json", url: '/promotions/create', data: { type: type, name: name, promotion: config, template: design, prizes: prizes, is_ajax: true, lang: (window.locale) ? window.locale : '', }, success: function(r) { callback && callback(r); }, error: function(jqXhr, textStatus, errorMessage) {} }); }, } };
! function() {
    "use strict";
    var e = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
        ...
        r = function() {
            for (var n, r = [
                ...
                if ((n = r[l]) && n[1] in e) { for (l = 0; l < n.length; l++) u[r[0][l]] = n[l]; return u }
            return !1
        }(),
        ...
        t = {
            request: function(n) {
                return new Promise(function(l, t) {
                    var u = function() { this.off("change", u), l() }.bind(this);
                    this.on("change", u);
            ...
            exit: function() {
                return new Promise(function(n, l) {
                    if (this.isFullscreen) {
                        var t = function() { this.off("change", t), n() }.bind(this);
                        this.on("change", t);
...
var JSConfetti = function() {
    ...
    function o(t) { return t[s(0, t.length)] }
    ...
    var h = function() {
        function e(i) {
            ...
            var n = i.initialPosition,
                ...
                d = i.canvasWidth,
                f = s(.9, 1.7, 3) * r(d);
            this.confettiSpeed = { x: f, y: f }, this.finalConfettiSpeedX = s(.2, .6, 3), this.rotationSpeed = u.length ? .01 : s(.03, .07, 3) * r(d), this.dragForceCoefficient = s(5e-4, 9e-4, 6), this.radius = { x: h, y: h }, this.initialRadius = h, this.rotationAngle = "left" === a ? s(0, .2, 3) : s(-.2, 0, 3), this.emojiSize = l, this.emojiRotationAngle = s(0, 2 * Math.PI), this.radiusYUpdateDirection = "down";
            var m = "left" === a ? s(82, 15) * Math.PI / 180 : s(-15, -82) * Math.PI / 180;
            this.absCos = Math.abs(Math.cos(m)), this.absSin = Math.abs(Math.sin(m));
            var p = s(-150, 0),
                v = { x: n.x + ("left" === a ? -p : p) * this.absCos, y: n.y - p * this.absSin };
        ...
        }, { key: "getIsVisibleOnCanvas", value: function(t) { return this.currentPosition.y < t + 100 } }]), e
    }();
    ...
    function u(t) {
        var e = t.confettiRadius,
            ...
            u = t.emojiSize,
            l = void 0 === u ? 80 : u;
        return t.emojies && console.error("emojies argument is deprecated, please use emojis instead"), t.confettiesNumber && console.error("confettiesNumber argument is deprecated, please use confettiNumber instead"), { confettiRadius: i, confettiNumber: s, confettiColors: r, emojis: c, emojiSize: l }
    }
    var l = function() {
        function e(i) {
            var n = this;
            t(this, e), this.canvasContext = i, this.shapes = [], this.promise = new Promise((function(t) { return n.resolvePromise = t }))
        }
        return i(e, [{ key: "getBatchCompletePromise", value: function() { return this.promise } }, {
            key: "addShapes",
            value: function() {
                var t;
                (t = this.shapes).push.apply(t, arguments)
            }
        }, { key: "complete", value: function() { var t; return !this.shapes.length && (null === (t = this.resolvePromise) || void 0 === t || t.call(this), !0) } }, {
            key: "processShapes",
            value: function(t, e, i) {
                var n = this,
                    s = t.timeDelta,
                    o = t.currentTime;
                this.shapes = this.shapes.filter((function(t) { return t.updatePosition(s, o), t.draw(n.canvasContext), !i || t.getIsVisibleOnCanvas(e) }))
            }
        }]), e
    }();
    return function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                this.activeConfettiBatches = this.activeConfettiBatches.filter((function(t) { return t.processShapes({ timeDelta: r, currentTime: a }, h, c), !c || !t.complete() })), this.iterationIndex++, this.queueAnimationFrameIfNeeded(a)
            }
        }, { key: "queueAnimationFrameIfNeeded", value: function(t) { this.requestAnimationFrameRequested || this.activeConfettiBatches.length < 1 || (this.requestAnimationFrameRequested = !0, this.lastUpdated = t || (new Date).getTime(), requestAnimationFrame(this.loop)) } }, {
            key: "addConfetti",
            value: function() {
                for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = u(t), i = e.confettiRadius, n = e.confettiNumber, s = e.confettiColors, o = e.emojis, a = e.emojiSize, r = this.canvas.getBoundingClientRect(), c = r.width, d = r.height, f = 5 * d / 7, m = { x: 0, y: f }, p = { x: c, y: f }, v = new l(this.canvasContext), g = 0; g < n / 2; g++) {
                    var y = new h({ initialPosition: m, direction: "right", confettiRadius: i, confettiColors: s, confettiNumber: n, emojis: o, emojiSize: a, canvasWidth: c }),
                        C = new h({ initialPosition: p, direction: "left", confettiRadius: i, confettiColors: s, confettiNumber: n, emojis: o, emojiSize: a, canvasWidth: c });
                    v.addShapes(y, C)
                }
...
var SoundPlayer = {};
SoundPlayer.sounds = {};
SoundPlayer.soundContext = new(window.AudioContext || window.webkitAudioContext)();
SoundPlayer.initialized = false;
SoundPlayer.init = function(sounds) {
    SoundPlayer.sounds = sounds;
    for (var key in SoundPlayer.sounds) { SoundPlayer.loadSound(key); }
...
SoundPlayer.setSounds = function(sounds) { SoundPlayer.sounds = sounds; };
SoundPlayer.tapped = function() {
    if (SoundPlayer.initialized) { return false; }
    for (var key in SoundPlayer.sounds) { SoundPlayer.play(key, { muted: true }, true); }
...
SoundPlayer.addSound = function(name, config, callback) {
    if (!SoundPlayer.sounds[name]) {
        ...
        SoundPlayer.loadSound(name, function() { if (callback) { callback(); } });
...
SoundPlayer.loadSound = function(name, callback) {
    ...
    request.onload = function() { SoundPlayer.soundContext.decodeAudioData(request.response, function(newBuffer) { sound.buffer = newBuffer; if (callback) { callback(name); } }); };
    request.send();
};
...
SoundPlayer.stopAll = function() { for (var key in SoundPlayer.sounds) { SoundPlayer.stop(key); } };
SoundPlayer.play = function(name, options, is_loading_sound, not_wait) {
    if (!SoundPlayer.initialized && !is_loading_sound) { setTimeout(function() { SoundPlayer.play(name, options); }, 500); return false; }
    var sound = SoundPlayer.sounds[name];
    if (sound.is_playing && !not_wait) { return false; }
    if (!is_loading_sound) { sound.is_playing = true; }
    ...
    if (buffer) {
        ...
        if (options) {
            if (options.volume) { volume.gain.value = soundVolume * options.volume; }
            if (options.muted) { volume.gain.value = 0; }
        } else { volume.gain.value = soundVolume; }
        volume.connect(SoundPlayer.soundContext.destination);
        source.connect(volume);
        if (options && options.loop) { source.loop = true; }
        source.start(0);
        source.onended = function() { sound.is_playing = false; };
    }
};

function Winwheel(options, drawWheel) {
    for (let key in defaultOptions = { canvasId: "canvas", centerX: null, centerY: null, outerRadius: null, innerRadius: 0, numSegments: 1, drawMode: "code", rotationAngle: 0, textFontFamily: "Arial", textFontSize: 20, textFontWeight: "bold", textOrientation: "horizontal", textAlignment: "center", textDirection: "normal", textMargin: null, textFillStyle: "black", textStrokeStyle: null, textLineWidth: 1, fillStyle: "silver", strokeStyle: "black", lineWidth: 1, clearTheCanvas: !0, imageOverlay: !1, drawText: !0, pointerAngle: 0, wheelImage: null, imageDirection: "N", responsive: !1, scaleFactor: 1 }) null != options && void 0 !== options[key] ? this[key] = options[key] : this[key] = defaultOptions[key];
    if (null != options)
        for (let key in options) void 0 === this[key] && (this[key] = options[key]);
    this.canvasId ? (this.canvas = document.getElementById(this.canvasId), this.canvas ? (null == this.centerX && (this.centerX = this.canvas.width / 2), null == this.centerY && (this.centerY = this.canvas.height / 2), null == this.outerRadius && (this.canvas.width < this.canvas.height ? this.outerRadius = this.canvas.width / 2 - this.lineWidth : this.outerRadius = this.canvas.height / 2 - this.lineWidth), this.ctx = this.canvas.getContext("2d")) : (this.canvas = null, this.ctx = null)) : (this.canvas = null, this.ctx = null), this.segments = new Array(null);
    for (let x = 1; x <= this.numSegments; x++) null != options && options.segments && void 0 !== options.segments[x - 1] ? this.segments[x] = new Segment(options.segments[x - 1]) : this.segments[x] = new Segment;
    if (this.updateSegmentSizes(), null === this.textMargin && (this.textMargin = this.textFontSize / 1.7), null != options && options.animation && void 0 !== options.animation ? this.animation = new Animation(options.animation) : this.animation = new Animation, null != options && options.pins && void 0 !== options.pins && (this.pins = new Pin(options.pins)), "image" == this.drawMode || "segmentImage" == this.drawMode ? (void 0 === options.fillStyle && (this.fillStyle = null), void 0 === options.strokeStyle && (this.strokeStyle = "red"), void 0 === options.drawText && (this.drawText = !1), void 0 === options.lineWidth && (this.lineWidth = 1), void 0 === drawWheel && (drawWheel = !1)) : void 0 === drawWheel && (drawWheel = !0), null != options && options.pointerGuide && void 0 !== options.pointerGuide ? this.pointerGuide = new PointerGuide(options.pointerGuide) : this.pointerGuide = new PointerGuide, this.responsive && (winwheelToDrawDuringAnimation = this, this._originalCanvasWidth = this.canvas.width, this._originalCanvasHeight = this.canvas.height, this._responsiveScaleHeight = this.canvas.dataset.responsivescaleheight, this._responsiveMinWidth = this.canvas.dataset.responsiveminwidth, this._responsiveMinHeight = this.canvas.dataset.responsiveminheight, this._responsiveMargin = this.canvas.dataset.responsivemargin, window.addEventListener("load", winwheelResize), window.addEventListener("resize", winwheelResize)), !0 == drawWheel) this.draw(this.clearTheCanvas);
    else if ("segmentImage" == this.drawMode) { winwheelToDrawDuringAnimation = this, winhweelAlreadyDrawn = !1; for (let y = 1; y <= this.numSegments; y++) null !== this.segments[y].image && (this.segments[y].imgData = new Image, this.segments[y].imgData.onload = winwheelLoadedImage, this.segments[y].imgData.src = this.segments[y].image) }
}

function Pin(options) {
    let defaultOptions = { visible: !0, number: 36, outerRadius: 3, fillStyle: "grey", strokeStyle: "black", lineWidth: 1, margin: 3, responsive: !1 };
    for (let key in defaultOptions) null != options && void 0 !== options[key] ? this[key] = options[key] : this[key] = defaultOptions[key];
    if (null != options)
        for (let key in options) void 0 === this[key] && (this[key] = options[key])
}

function Animation(options) {
    let defaultOptions = { type: "spinOngoing", direction: "clockwise", propertyName: null, propertyValue: null, duration: 10, yoyo: !1, repeat: null, easing: null, stopAngle: null, spins: null, clearTheCanvas: null, callbackFinished: null, callbackBefore: null, callbackAfter: null, callbackSound: null, soundTrigger: "segment" };
    for (let key in defaultOptions) null != options && void 0 !== options[key] ? this[key] = options[key] : this[key] = defaultOptions[key];
    if (null != options)
        for (let key in options) void 0 === this[key] && (this[key] = options[key])
}
...
function PointerGuide(options) { let defaultOptions = { display: !1, strokeStyle: "red", lineWidth: 3 }; for (let key in defaultOptions) null != options && void 0 !== options[key] ? this[key] = options[key] : this[key] = defaultOptions[key] }

function winwheelPercentToDegrees(percentValue) { let degrees = 0; return percentValue > 0 && percentValue <= 100 && (degrees = 360 * (percentValue / 100)), degrees }

function winwheelAnimationLoop() {
    if (winwheelToDrawDuringAnimation) {
        !1 != winwheelToDrawDuringAnimation.animation.clearTheCanvas && winwheelToDrawDuringAnimation.ctx.clearRect(0, 0, winwheelToDrawDuringAnimation.canvas.width, winwheelToDrawDuringAnimation.canvas.height);
        ...
        null != callbackBefore && ("function" == typeof callbackBefore ? callbackBefore() : eval(callbackBefore)), winwheelToDrawDuringAnimation.draw(!1), null != callbackAfter && ("function" == typeof callbackAfter ? callbackAfter() : eval(callbackAfter)), winwheelToDrawDuringAnimation.animation.callbackSound && winwheelTriggerSound()
    }
}

function winwheelTriggerSound() {
    !1 == winwheelToDrawDuringAnimation.hasOwnProperty("_lastSoundTriggerNumber") && (winwheelToDrawDuringAnimation._lastSoundTriggerNumber = 0);
    let callbackSound = winwheelToDrawDuringAnimation.animation.callbackSound,
        currentTriggerNumber = 0;
    (currentTriggerNumber = "pin" == winwheelToDrawDuringAnimation.animation.soundTrigger ? winwheelToDrawDuringAnimation.getCurrentPinNumber() : winwheelToDrawDuringAnimation.getIndicatedSegmentNumber()) != winwheelToDrawDuringAnimation._lastSoundTriggerNumber && ("function" == typeof callbackSound ? callbackSound() : eval(callbackSound), winwheelToDrawDuringAnimation._lastSoundTriggerNumber = currentTriggerNumber)
}
Winwheel.prototype.updateSegmentSizes = function() {
    if (this.segments) {
        let d = 0,
            e = 0;
        for (let b = 1; b <= this.numSegments; b++) null !== this.segments[b].size && (d += this.segments[b].size, e++);
        let f = 360 - d,
            g = 0;
        f > 0 && (g = f / (this.numSegments - e));
        let c = 0;
        for (let a = 1; a <= this.numSegments; a++) this.segments[a].startAngle = c, this.segments[a].size ? c += this.segments[a].size : c += g, this.segments[a].endAngle = c
    }
}, Winwheel.prototype.clearCanvas = function() { this.ctx && this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height) }, Winwheel.prototype.draw = function(a) { this.ctx && (void 0 !== a ? !0 == a && this.clearCanvas() : this.clearCanvas(), "image" == this.drawMode ? (this.drawWheelImage(), !0 == this.drawText && this.drawSegmentText(), !0 == this.imageOverlay && this.drawSegments()) : "segmentImage" == this.drawMode ? (this.drawSegmentImages(), !0 == this.drawText && this.drawSegmentText(), !0 == this.imageOverlay && this.drawSegments()) : (this.drawSegments(), !0 == this.drawText && this.drawSegmentText()), void 0 !== this.pins && !0 == this.pins.visible && this.drawPins(), !0 == this.pointerGuide.display && this.drawPointerGuide()) }, Winwheel.prototype.drawPins = function() {
    if (this.pins && this.pins.number) {
        let a = this.centerX * this.scaleFactor,
            ...
            e = this.pins.margin;
        this.pins.responsive && (c = this.pins.outerRadius * this.scaleFactor, e = this.pins.margin * this.scaleFactor);
        let g = 360 / this.pins.number;
        for (let d = 1; d <= this.pins.number; d++) this.ctx.save(), this.ctx.strokeStyle = this.pins.strokeStyle, this.ctx.lineWidth = this.pins.lineWidth, this.ctx.fillStyle = this.pins.fillStyle, this.ctx.translate(a, b), this.ctx.rotate(this.degToRad(d * g + this.rotationAngle)), this.ctx.translate(-a, -b), this.ctx.beginPath(), this.ctx.arc(a, b - f + c + e, c, 0, 2 * Math.PI), this.pins.fillStyle && this.ctx.fill(), this.pins.strokeStyle && this.ctx.stroke(), this.ctx.restore()
    }
    ...
    if (this.ctx) {
        ...
        this.ctx.save(), this.ctx.translate(a, b), this.ctx.rotate(this.degToRad(this.pointerAngle)), this.ctx.translate(-a, -b), this.ctx.strokeStyle = this.pointerGuide.strokeStyle, this.ctx.lineWidth = this.pointerGuide.lineWidth, this.ctx.beginPath(), this.ctx.moveTo(a, b), this.ctx.lineTo(a, -(c / 4)), this.ctx.stroke(), this.ctx.restore()
    }
    ...
    if (null != this.wheelImage) {
        let a = this.centerX * this.scaleFactor,
            ...
            e = a - c / 2,
            f = b - d / 2;
        this.ctx.save(), this.ctx.translate(a, b), this.ctx.rotate(this.degToRad(this.rotationAngle)), this.ctx.translate(-a, -b), this.ctx.drawImage(this.wheelImage, e, f, c, d), this.ctx.restore()
    }
        ...
        if (this.segments)
            for (let g = 1; g <= this.numSegments; g++) {
                ...
                if (a.imgData.height) {
                    ...
                    "S" == (j = null !== a.imageDirection ? a.imageDirection : this.imageDirection) ? (d = b - h / 2, e = c, f = a.startAngle + 180 + (a.endAngle - a.startAngle) / 2) : "E" == j ? (d = b, e = c - i / 2, f = a.startAngle + 270 + (a.endAngle - a.startAngle) / 2) : "W" == j ? (d = b - h, e = c - i / 2, f = a.startAngle + 90 + (a.endAngle - a.startAngle) / 2) : (d = b - h / 2, e = c - i, f = a.startAngle + (a.endAngle - a.startAngle) / 2), this.ctx.save(), this.ctx.translate(b, c), this.ctx.rotate(this.degToRad(this.rotationAngle + f)), this.ctx.translate(-b, -c), this.ctx.drawImage(a.imgData, d, e, h, i), this.ctx.restore()
    ...
    if (this.ctx && this.segments) {
        ...
        for (let h = 1; h <= this.numSegments; h++) {
            let a = this.segments[h],
                e, b, f;
            if (e = null !== a.fillStyle ? a.fillStyle : this.fillStyle, this.ctx.fillStyle = e, b = null !== a.lineWidth ? a.lineWidth : this.lineWidth, this.ctx.lineWidth = b, f = null !== a.strokeStyle ? a.strokeStyle : this.strokeStyle, this.ctx.strokeStyle = f, f || e) {
                if (this.ctx.beginPath(), this.innerRadius) {
                    let j = Math.cos(this.degToRad(a.startAngle + this.rotationAngle - 90)) * (g - b / 2),
                        k = Math.sin(this.degToRad(a.startAngle + this.rotationAngle - 90)) * (g - b / 2);
                    this.ctx.moveTo(c + j, d + k)
                } else this.ctx.moveTo(c, d);
                this.ctx.arc(c, d, i + b / 2, this.degToRad(a.startAngle + this.rotationAngle - 90), this.degToRad(a.endAngle + this.rotationAngle - 90), !1), this.innerRadius && this.ctx.arc(c, d, g, this.degToRad(a.endAngle + this.rotationAngle - 90), this.degToRad(a.startAngle + this.rotationAngle - 90), !0), e && this.ctx.fill(), f && this.ctx.stroke()
            }
        }
    }
}, Winwheel.prototype.drawSegmentText = function() {
    if (this.ctx) {
        let x, m, y, n, f, M, h, j, k, N, b = this.centerX * this.scaleFactor,
        ...
        for (let z = 1; z <= this.numSegments; z++) {
            ...
            if (a.text) {
                x = null !== a.textFontFamily ? a.textFontFamily : this.textFontFamily, m = null !== a.textFontSize ? a.textFontSize : this.textFontSize, y = null !== a.textFontWeight ? a.textFontWeight : this.textFontWeight, n = null !== a.textOrientation ? a.textOrientation : this.textOrientation, f = null !== a.textAlignment ? a.textAlignment : this.textAlignment, M = null !== a.textDirection ? a.textDirection : this.textDirection, h = null !== a.textMargin ? a.textMargin : this.textMargin, j = null !== a.textFillStyle ? a.textFillStyle : this.textFillStyle, k = null !== a.textStrokeStyle ? a.textStrokeStyle : this.textStrokeStyle, N = null !== a.textLineWidth ? a.textLineWidth : this.textLineWidth, m *= this.scaleFactor, h *= this.scaleFactor;
                let u = "";
                null != y && (u += y + " "), null != m && (u += m + "px "), null != x && (u += x), this.ctx.font = u, this.ctx.fillStyle = j, this.ctx.strokeStyle = k, this.ctx.lineWidth = N;
                let c = a.text.split("\n"),
                ...
                for (let d = 0; d < c.length; d++) {
                    if ("reversed" == M) {
                        if ("horizontal" == n) {
                            "inner" == f ? this.ctx.textAlign = "right" : "outer" == f ? this.ctx.textAlign = "left" : this.ctx.textAlign = "center", this.ctx.textBaseline = "middle";
                            let $ = this.degToRad(a.endAngle - (a.endAngle - a.startAngle) / 2 + this.rotationAngle - 90 - 180);
                            this.ctx.save(), this.ctx.translate(b, e), this.ctx.rotate($), this.ctx.translate(-b, -e), "inner" == f ? (j && this.ctx.fillText(c[d], b - i - h, e + g), k && this.ctx.strokeText(c[d], b - i - h, e + g)) : "outer" == f ? (j && this.ctx.fillText(c[d], b - l + h, e + g), k && this.ctx.strokeText(c[d], b - l + h, e + g)) : (j && this.ctx.fillText(c[d], b - i - (l - i) / 2 - h, e + g), k && this.ctx.strokeText(c[d], b - i - (l - i) / 2 - h, e + g)), this.ctx.restore()
                        } else if ("vertical" == n) {
                            this.ctx.textAlign = "center", "inner" == f ? this.ctx.textBaseline = "top" : "outer" == f ? this.ctx.textBaseline = "bottom" : this.ctx.textBaseline = "middle";
                            let O = a.endAngle - (a.endAngle - a.startAngle) / 2 - 180;
                            O += this.rotationAngle, this.ctx.save(), this.ctx.translate(b, e), this.ctx.rotate(this.degToRad(O)), this.ctx.translate(-b, -e);
                            let o = 0;
                            "outer" == f ? o = e + l - h : "inner" == f && (o = e + i + h);
                            let v = m - m / 9;
                            if ("outer" == f)
                                for (let A = c[d].length - 1; A >= 0; A--) {
                                    let P = c[d].charAt(A);
                                    j && this.ctx.fillText(P, b + g, o), k && this.ctx.strokeText(P, b + g, o), o -= v
                                } else if ("inner" == f)
                                    for (let B = 0; B < c[d].length; B++) {
                                        let Q = c[d].charAt(B);
                                        j && this.ctx.fillText(Q, b + g, o), k && this.ctx.strokeText(Q, b + g, o), o += v
                                    } else if ("center" == f) {
                                        let R = 0;
                                        ...
                                        for (let D = c[d].length - 1; D >= 0; D--) {
                                            let S = c[d].charAt(D);
                                            j && this.ctx.fillText(S, b + g, C), k && this.ctx.strokeText(S, b + g, C), C -= v
                                        }
                                    }
                            this.ctx.restore()
                        } else if ("curved" == n) {
                            let q = 0;
                            "inner" == f ? (q = i + h, this.ctx.textBaseline = "top") : "outer" == f ? (q = l - h, this.ctx.textBaseline = "bottom", q -= m * (c.length - 1)) : "center" == f && (q = i + h + (l - i) / 2, this.ctx.textBaseline = "middle");
                            let E = 0,
                                s = 0;
                            if (c[d].length > 1) {
                            ...
                            } else s = a.startAngle + (a.endAngle - a.startAngle) / 2, this.ctx.textAlign = "center";
                            s += this.rotationAngle, s -= 180;
                            for (let F = c[d].length; F >= 0; F--) {
                                this.ctx.save();
                                let T = c[d].charAt(F);
                                this.ctx.translate(b, e), this.ctx.rotate(this.degToRad(s)), this.ctx.translate(-b, -e), k && this.ctx.strokeText(T, b, e + q + g), j && this.ctx.fillText(T, b, e + q + g), s += E, this.ctx.restore()
                            }
                        }
                    } else if ("horizontal" == n) {
                        "inner" == f ? this.ctx.textAlign = "left" : "outer" == f ? this.ctx.textAlign = "right" : this.ctx.textAlign = "center", this.ctx.textBaseline = "middle";
                        let aa = this.degToRad(a.endAngle - (a.endAngle - a.startAngle) / 2 + this.rotationAngle - 90);
                        this.ctx.save(), this.ctx.translate(b, e), this.ctx.rotate(aa), this.ctx.translate(-b, -e), "inner" == f ? (j && this.ctx.fillText(c[d], b + i + h, e + g), k && this.ctx.strokeText(c[d], b + i + h, e + g)) : "outer" == f ? (j && this.ctx.fillText(c[d], b + l - h, e + g), k && this.ctx.strokeText(c[d], b + l - h, e + g)) : (j && this.ctx.fillText(c[d], b + i + (l - i) / 2 + h, e + g), k && this.ctx.strokeText(c[d], b + i + (l - i) / 2 + h, e + g)), this.ctx.restore()
                    } else if ("vertical" == n) {
                        this.ctx.textAlign = "center", "inner" == f ? this.ctx.textBaseline = "bottom" : "outer" == f ? this.ctx.textBaseline = "top" : this.ctx.textBaseline = "middle";
                        let U = a.endAngle - (a.endAngle - a.startAngle) / 2;
                        U += this.rotationAngle, this.ctx.save(), this.ctx.translate(b, e), this.ctx.rotate(this.degToRad(U)), this.ctx.translate(-b, -e);
                        let p = 0;
                        ...
                        if ("outer" == f)
                            for (let G = 0; G < c[d].length; G++) {
                                let V = c[d].charAt(G);
                                j && this.ctx.fillText(V, b + g, p), k && this.ctx.strokeText(V, b + g, p), p += w
                            } else if ("inner" == f)
                                for (let H = c[d].length - 1; H >= 0; H--) {
                                    let W = c[d].charAt(H);
                                    j && this.ctx.fillText(W, b + g, p), k && this.ctx.strokeText(W, b + g, p), p -= w
                                } else if ("center" == f) {
                                    let X = 0;
                                    ...
                                    for (let J = 0; J < c[d].length; J++) {
                                        let Y = c[d].charAt(J);
                                        j && this.ctx.fillText(Y, b + g, I), k && this.ctx.strokeText(Y, b + g, I), I += w
                                    }
                                }
                        this.ctx.restore()
                    } else if ("curved" == n) {
                        let r = 0;
                        "inner" == f ? (r = i + h, this.ctx.textBaseline = "bottom", r += m * (c.length - 1)) : "outer" == f ? (r = l - h, this.ctx.textBaseline = "top") : "center" == f && (r = i + h + (l - i) / 2, this.ctx.textBaseline = "middle");
                        let K = 0,
                            t = 0;
                        if (c[d].length > 1) {
                        ...
                        } else t = a.startAngle + (a.endAngle - a.startAngle) / 2, this.ctx.textAlign = "center";
                        t += this.rotationAngle;
                        for (let L = 0; L < c[d].length; L++) {
                            this.ctx.save();
                            let Z = c[d].charAt(L);
                            this.ctx.translate(b, e), this.ctx.rotate(this.degToRad(t)), this.ctx.translate(-b, -e), k && this.ctx.strokeText(Z, b, e - r + g), j && this.ctx.fillText(Z, b, e - r + g), t += K, this.ctx.restore()
                        }
                    }
                    g += m
                }
...
}, Winwheel.prototype.degToRad = function(a) { return .017453292519943295 * a }, Winwheel.prototype.setCenter = function(a, b) { this.centerX = a, this.centerY = b }, Winwheel.prototype.addSegment = function(e, a) {
    let d = new Segment(e);
    this.numSegments++;
    let c;
    if (void 0 !== a) {
        for (let b = this.numSegments; b > a; b--) this.segments[b] = this.segments[b - 1];
...
}, Winwheel.prototype.setCanvasId = function(a) { a ? (this.canvasId = a, this.canvas = document.getElementById(this.canvasId), this.canvas && (this.ctx = this.canvas.getContext("2d"))) : (this.canvasId = null, this.ctx = null, this.canvas = null) }, Winwheel.prototype.deleteSegment = function(b) {
    if (this.numSegments > 1) {
        if (void 0 !== b)
            for (let a = b; a < this.numSegments; a++) this.segments[a] = this.segments[a + 1];
        this.segments[this.numSegments] = void 0, this.segments.pop(), this.numSegments--, this.updateSegmentSizes()
    }
}, Winwheel.prototype.windowToCanvas = function(b, c) { let a = this.canvas.getBoundingClientRect(); return { x: Math.floor(b - a.left * (this.canvas.width / a.width)), y: Math.floor(c - a.top * (this.canvas.height / a.height)) } }, Winwheel.prototype.getSegmentAt = function(c, d) {
    let a = null,
    ...
    let b = this.windowToCanvas(m, n),
        c, d, e, f, i, j = this.centerX * this.scaleFactor,
        k = this.centerY * this.scaleFactor,
        o = this.outerRadius * this.scaleFactor,
        p = this.innerRadius * this.scaleFactor;
    b.x > j ? (e = b.x - j, d = "R") : (e = j - b.x, d = "L"), b.y > k ? (f = b.y - k, c = "B") : (f = k - b.y, c = "T");
    let h = 180 * Math.atan(f / e) / Math.PI,
        a = 0;
    i = Math.sqrt(f * f + e * e), "T" == c && "R" == d ? a = Math.round(90 - h) : "B" == c && "R" == d ? a = Math.round(h + 90) : "B" == c && "L" == d ? a = Math.round(90 - h + 180) : "T" == c && "L" == d && (a = Math.round(h + 270)), 0 != this.rotationAngle && (a -= this.getRotationPosition()) < 0 && (a = 360 - Math.abs(a));
    let l = null;
    for (let g = 1; g <= this.numSegments; g++)
        if (a >= this.segments[g].startAngle && a <= this.segments[g].endAngle && i >= p && i <= o) { l = g; break }
    return l
}, Winwheel.prototype.getIndicatedSegment = function() { let a = this.getIndicatedSegmentNumber(); return this.segments[a] }, Winwheel.prototype.getIndicatedSegmentNumber = function() {
    let c = 0,
        d = this.getRotationPosition(),
        a = Math.floor(this.pointerAngle - d);
    a < 0 && (a = 360 - Math.abs(a));
    for (let b = 1; b < this.segments.length; b++)
        if (a >= this.segments[b].startAngle && a <= this.segments[b].endAngle) { c = b; break }
    return c
    ...
    if (this.pins) {
        ...
        for (let d = 0; d < this.pins.number; d++) {
            if (a >= c && a <= c + e) { b = d; break }
            c += e
        }
        "clockwise" == this.animation.direction && ++b > this.pins.number && (b = 0)
    }
    return b
...
function winwheelLoadedImage() {
    if (!1 == winhweelAlreadyDrawn) {
        ...
        for (let i = 1; i <= winwheelToDrawDuringAnimation.numSegments; i++) null != winwheelToDrawDuringAnimation.segments[i].imgData && winwheelToDrawDuringAnimation.segments[i].imgData.height && winwheelImageLoadCount++;
...
function winwheelResize() {
    let margin = 40;
    void 0 !== winwheelToDrawDuringAnimation._responsiveMargin && (margin = winwheelToDrawDuringAnimation._responsiveMargin);
    ...
    width < minWidth ? width = minWidth : width > winwheelToDrawDuringAnimation._originalCanvasWidth && (width = winwheelToDrawDuringAnimation._originalCanvasWidth);
    let percent = width / winwheelToDrawDuringAnimation._originalCanvasWidth;
    if (winwheelToDrawDuringAnimation.canvas.width = winwheelToDrawDuringAnimation._originalCanvasWidth * percent, winwheelToDrawDuringAnimation._responsiveScaleHeight) {
        let height = winwheelToDrawDuringAnimation._originalCanvasHeight * percent;
        height < minHeight ? height = minHeight : height > winwheelToDrawDuringAnimation._originalCanvasHeight && (height = winwheelToDrawDuringAnimation._originalCanvasHeight), winwheelToDrawDuringAnimation.canvas.height = height
    }
    winwheelToDrawDuringAnimation.scaleFactor = percent, winwheelToDrawDuringAnimation.draw()
}
var __DATA_WHEEL_THEMES__ = [{ page_background_color: '#D1E4FF', main_color: '#1a1a1a', action_color: '#9ad0e6', wheel_dots_color: '#f199a0', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#9ad0e6', wheel_slices_text_color: 'auto', wheel_slices_color: ['#5B68BB', '#A746B9', '#E33F76', '#EB5B4F', '#F7A126', '#F7BF46', '#F7E756', '#CEDA53', '#95C955', '#25A095', '#3EA0ED'], }, { page_background_color: '#D1E4FF', main_color: '#1a1a1a', action_color: '#9ad0e6', wheel_dots_color: '#f199a0', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#9ad0e6', wheel_slices_text_color: 'auto', wheel_slices_color: ['#7eecec', '#7280fd', '#fff171', '#ff7878'], }, { page_background_color: '#012d41', main_color: '#ffffff', action_color: '#9ad0e6', wheel_dots_color: '#f199a0', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#9ad0e6', wheel_slices_text_color: 'auto', wheel_slices_color: ['#ff404e', '#D8DCF3', '#1ba5b8', '#daecf3'], }, { page_background_color: '#680052', main_color: '#ffffff', action_color: '#ecabe4', wheel_dots_color: '#cd9cd8', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#ecabe4', wheel_slices_text_color: 'auto', wheel_slices_color: ['#680052', '#360541', '#863297', '#db9be4'], }, { page_background_color: '#797DD7', main_color: '#ffffff', action_color: '#011646', wheel_dots_color: '#4D3C86', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#515AA4', wheel_slices_text_color: '#FFFFFF', wheel_slices_text_color: 'auto', wheel_slices_color: ['#949cdf', '#a7c5eb', '#f6ecf0'], }, { page_background_color: '#4f4f4f', main_color: '#ffffff', action_color: '#D2BE46', wheel_dots_color: '#62531E', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#62531E', wheel_slices_text_color: '#342323', wheel_slices_color: ['#C6B86C', '#efe8bc', '#d2be46', '#eee6ba'], }, { page_background_color: '#9F5F80', main_color: '#ffffff', action_color: '#ECAB89', wheel_dots_color: '#FFFFFF', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#5E3651', wheel_slices_text_color: 'auto', wheel_slices_color: ['#ffba93', '#9f5f80', ], }, { page_background_color: '#E9F0DB', main_color: '#28583A', action_color: '#9ECCA4', wheel_dots_color: '#FFFFFF', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#5D764C', wheel_slices_text_color: '#342323', wheel_slices_color: ['#cee6b4', '#9ecca4', ], }, { page_background_color: '#F7CFCF', main_color: '#212121', action_color: '#E67979', wheel_dots_color: '#973549', wheel_border_color: '#973549', wheel_pointer_color: '#973549', wheel_slices_text_color: '#342323', wheel_slices_color: ['#ff8fa3', '#f9f9f9', ], }, { page_background_color: '#263627', main_color: '#FFFFFF', action_color: '#91B693', wheel_dots_color: '#1E6C23', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#1E6C23', wheel_slices_text_color: '#342323', wheel_slices_color: ['#52c758', '#beeac0', ], }, { page_background_color: '#edf6f9', main_color: '#303a53', action_color: '#9ad0e6', wheel_dots_color: '#f199a0', wheel_border_color: '#FFFFFF', wheel_pointer_color: '#9ad0e6', wheel_slices_text_color: 'auto', wheel_slices_color: ['#264653', '#EDF6F9', '#2a9d8f', '#e9c46a', '#f4a261', '#e76f51'], }, ];
var a0_0x5e4a = ['is_inactive_wheel', 'updatePinNumbers', 'event', 'getRandomHash', 'onload', 'DELETE', 'wheel_add_option_list_original', 'height', 'show_desc', 'prizes', 'advanced_mode', '[data-target=\x22#Customizer_Section_Form\x22]', 'authModal', 'src', 'run', 'assign', 'rotationAngle', 'width', 'config', 'load', 'max_chance_available', 'image/jpeg', '99%', 'stopAngle', 'showModal', 'join', 'disabled', 'app_wheel.default_prize_text', '90%', '__SAVED_WHEELS__', 'start_button', 'onSaveWheel', 'then', 'cover', 'theWheel', 'Inter', 'toFixed', 'unique_page_view', 'target', 'white', '40px', 'capture_leads', 'trigger', 'createPromotion', 'split', '#1a1a1a', '#app', 'bind', 'wheel_temporal_hash', 'rgba(0,0,0,.2)', 'toString', 'wheel_add_option_textarea', 'settings', 'getPrizeChanceAvailable', 'wheel_segment_index', 'title', 'wheel_spin_duration', 'rgba(', 'value', 'participants', 'result', 'hash', '.wof__wheel__pointer', 'is_wheel_centered', 'filter', 'wheel_lines_size', 'setup', 'participants_prev', 'Create_New_Wheel', '.hide-logged-in', 'canvas', 'isFullscreen', 'app_wheel.error_default_entries', 'spins', 'buttons.delete', 'spinWhileWaiting', 'track', 'Montevideo', 'showClassicWheelUpgrade', 'location', 'save_form', 'warn', 'upgrade.classic_wheel.feature5', 'setUser', 'upgrade.classic_wheel.feature3', 'history', '/api/wheels/track?verbose=1&ip=1&_=', 'startAnimation', 'numSegments', '/img/apps/wheel-center-logo-default.jpg', 'files', '{}.constructor(\x22return\x20this\x22)(\x20)', 'wheel_border_color', 'open', 'total_entries', 'forEach', 'hideModal', 'wheel_dots_color', 'ERROR_NO_USER', 'border', 'slice', 'source', '/media/tick.mp3', 'error', '#wheelShareModal', 'attr', 'edit_entry_modal', 'notifications.saved_changes', 'no-repeat', 'post', '/dashboard?deleted=1', 'shuffle', '', 'play', '.wof__wheel', 'Uploaded_Logo', 'show', 'upgrade.classic_wheel.feature4', 'ceil', 'Theme_Selected', 'custom_logo', 'getWeightedRandomSegmentIndex', 'removeClass', 'toast', 'offsetWidth', '.promotion-editor-sidebar-body', '85%', '#saveModal', 'Roma', 'wheel_auto_remove', 'length', 'app_wheel.default_prize_empty_4', 'now', 'isEnabled', 'trace', 'share_url', 'Pekin', '#7280fd', 'AS_CreatedWheel', 'is_full_screen', 'clear', 'last_sort', 'concat', 'playFxEnd', 'auto', 'AuthModal', 'main_color', 'toDataURL', 'show_upgrade_after_login', 'trim', 'show_title', 'last_segment_picked', 'modal', '/api/wheels/delete', 'css', 'app_wheel.default_prize_empty_1', 'Buenos\x20Aires', 'showConfirm', 'custom_bg', 'dong', 'getParticipantsListFromPrizes', 'subscription', 'updateWheelStroke', 'AS_LeadsWheelSelected', 'hidden', 'AS_LeadsWheelCreated', 'customizer_mobile_opened', 'WheelDecide_v2', 'resetValues', 'spinToStop', 'effect_spin_zoom', 'isPlaying', 'addEventListener', 'upgrade.classic_wheel_text', 'wheel_slices_text_color', 'table', 'keyCode', 'saving', '#screencast', 'refreshSliceColors', 'href', 'AS_WheelUserAction', 'toggle', 'is_customer', 'hide', 'change', '300px', 'improve_slices', 'hex_is_light', 'fireConfettis', 'url', '.user-picture', 'mode', 'substr', 'getElementById', 'plan_id', 'app_wheel.start_button_placeholder', 'results', 'lineWidth', 'options', 'design', 'colors', 'calculated_auto_chance', 'show_confettis', 'success', 'play_sounds', '#design', 'calculated_chance', 'spin-links', 'ajax', 'floor', 'editColorsModal', 'AS_UpdatedWheel', 'backgroundImage', '75%', '#FFFFFF', 'Wheel_Preview_Click', '?hash=', 'alertPrize', 'choices', 'savedWheel', 'Fullscreen\x20mode:\x20', 'outer', 'upgrade.pick_best_plan', 'SpinWheel', 'action_color', 'checkUserSubStatus', 'Berlín', 'data', 'duration', 'pins', 'strokeStyle', 'drawImage', '#fff171', 'is_wheel_play_only', 'text', 'prototype', 'showSubscriptionUpgradeModal', 'random', 'onEditBulkEntries', 'wheel_fx_sound', '/media/ding.mp3', 'name', 'pushState', 'user', 'total_custom_chance', 'wheel_add_option_list', '#111111', 'show_save_modal_after_login', 'exception', 'enabled', 'show_winners', 'Londres', 'index', 'onPrizeChanceChange', 'gtag', 'onStopPlaying', 'jsConfetti', 'saved_wheels', 'empty', 'upgrade.classic_wheel.feature1', 'fillStyle', 'description', 'animation', 'segments', '#wof', 'spin', 'chance', '.wof__wheel__winner', 'replace', 'logo', 'notifications.success_login', 'onPrizeInputChange', 'app_wheel.default_title', 'textFillStyle', 'body', '/api/wheels/save', 'log', 'json', 'notifications.copied_to_clipboard', 'media-gallery', '#Customizer_Section_Prizes', 'addConfetti', 'click', 'getRandomSegmentIndex', '#7eecec', '#ff7878', 'overflow', '#000000', 'page_background_color', 'sort', 'saveWheel', 'locale', 'substring', 'collapse', 'deleteSegment', 'upgrade.classic_wheel.title', 'backgroundRepeat', 'initTooltips', 'user_id', '.collapsed[data-target=\x22#Customizer_Section_Prizes\x22]', 'wheel_options_textarea', 'getGlobalLink', 'picture', 'map', 'is_editing_bulk', 'addClass', 'is_mobile', 'upload_logo_input', 'spin-btn-alone', 'jsccc', 'apply', 'initKeyHandlers', 'initial', 'onLaunchWheel', 'themes', 'getRandomForSegment', 'show_start_button', '#1B2430', 'wheel.confirm_delete', 'upgrade.classic_wheel.text', 'splice', 'number', 'getSliceMaxTextLength', 'totalWeight', 'stringify', 'AS_SpinWheel', '.show-logged-in', 'backgroundSize', 'fortune-wheel', 'resizeDownDataUrlKeepProportions', '#capture_leads', 'app_wheel.default_description', '$refs', 'wheel_pointer_color', 'Lima', 'customize_tab', 'Something\x20went\x20wrong,\x20please\x20try\x20again.', 'wheel_slices_color', 'Uploaded_Background', 'onCaptureLeadsChange', '#wheelPrizeModal', 'page_background_image', 'wheel_add_option_input', 'originalText', 'readAsDataURL', 'popstate', 'console', 'draw', 'edit', 'onItemDeleted', 'createElement', 'wheel_segment_name', 'push', 'preventDefault', 'app_wheel.default_prize_empty_2'];
(function(_0x337ddb, _0x5e4a7f) {
    var _0x5f14e3 = function(_0x4c6c30) { while (--_0x4c6c30) { _0x337ddb['push'](_0x337ddb['shift']()); } };
    _0x5f14e3(++_0x5e4a7f);
}(a0_0x5e4a, 0x13c));
var a0_0x5f14 = function(_0x337ddb, _0x5e4a7f) { _0x337ddb = _0x337ddb - 0x0; var _0x5f14e3 = a0_0x5e4a[_0x337ddb]; return _0x5f14e3; };
var a0_0x13aa32 = function() { var _0x3389fd = !![]; return function(_0x4fe7dc, _0x4fccf6) { var _0x2d0c26 = _0x3389fd ? function() { if (_0x4fccf6) { var _0x53374c = _0x4fccf6[a0_0x5f14('0x15f')](_0x4fe7dc, arguments); return _0x4fccf6 = null, _0x53374c; } } : function() {}; return _0x3389fd = ![], _0x2d0c26; }; }(),
    a0_0x130cb5 = a0_0x13aa32(this, function() {
        var _0x6cec91;
        try {
            var _0xad9b6e = Function('return\x20(function()\x20' + a0_0x5f14('0x83') + ');');
            _0x6cec91 = _0xad9b6e();
        } catch (_0x88dcc1) { _0x6cec91 = window; }
        var _0x489268 = _0x6cec91[a0_0x5f14('0x1f')] = _0x6cec91[a0_0x5f14('0x1f')] || {},
            _0x291dea = [a0_0x5f14('0x13d'), a0_0x5f14('0x79'), 'info', a0_0x5f14('0x8f'), a0_0x5f14('0x121'), a0_0x5f14('0xd7'), a0_0x5f14('0xae')];
        for (var _0x468ce0 = 0x0; _0x468ce0 < _0x291dea[a0_0x5f14('0xaa')]; _0x468ce0++) {
            var _0x38a952 = a0_0x13aa32['constructor'][a0_0x5f14('0x114')][a0_0x5f14('0x57')](a0_0x13aa32),
                _0x584b13 = _0x291dea[_0x468ce0],
                _0x379965 = _0x489268[_0x584b13] || _0x38a952;
            _0x38a952['__proto__'] = a0_0x13aa32[a0_0x5f14('0x57')](a0_0x13aa32), _0x38a952[a0_0x5f14('0x5a')] = _0x379965[a0_0x5f14('0x5a')][a0_0x5f14('0x57')](_0x379965), _0x489268[_0x584b13] = _0x38a952;
        }
    });
a0_0x130cb5(), SoundPlayer['init']({ 'tick': { 'url': a0_0x5f14('0x8e') }, 'end': { 'url': '/media/wd-sound-fx-end.mp3' }, 'ding': { 'url': a0_0x5f14('0x119') }, 'dong': { 'url': '/media/wof_dong.ogg' } });
var __default_slice_colors = [a0_0x5f14('0x145'), a0_0x5f14('0xb1'), a0_0x5f14('0x111'), a0_0x5f14('0x146')],
    __default_names = [],
    ...
    app = new Vue({
        ...
        'data': { 'is_customer': ![], 'colors': __default_slice_colors, 'saving': ![], 'participants': __default_names, 'participants_prev': [], 'prizes': [], 'results': [], 'savedWheel': {}, 'theWheel': null, 'jsConfetti': null, 'mode': a0_0x5f14('0x21'), 'customize_tab': a0_0x5f14('0x3a'), 'customizer_mobile_opened': ![], 'edit_entry_modal': null, 'wheel_options': [], 'wheel_options_textarea': '', 'saved_wheels': [], 'show_upgrade_after_login': ![], 'show_save_modal_after_login': ![], 'is_inactive_wheel': !![], 'is_mobile': ![], 'is_full_screen': ![], 'is_wheel_spinning': ![], 'is_wheel_centered': ![], 'is_editing_bulk': ![], 'is_wheel_play_only': ![], 'wheel_segment_index': null, 'wheel_segment_name': null, 'wheel_temporal_hash': null, 'last_segment_picked': null, 'wheel_add_option_input': '', 'wheel_add_option_textarea': '', 'wheel_add_option_list': [], 'wheel_add_option_list_original': [], 'show_winners': ![], 'show_design_advanced_settings': ![], 'last_sort': 'za', 'save_form': { 'name': '' }, 'config': { 'title': '', 'description': '', 'start_button': '', 'effect_spin_zoom': !![], 'capture_leads': ![], 'show_title': ![], 'show_desc': ![], 'show_start_button': ![], 'show_confettis': !![], 'play_sounds': !![], 'wheel_spin_duration': 0xa, 'wheel_fx_sound': a0_0x5f14('0xc7'), 'wheel_auto_remove': ![], 'advanced_mode': ![], 'improve_slices': ![] }, 'design': { 'logo': '', 'page_background_color': '#D1E4FF', 'page_background_image': '', 'container_background_color': a0_0x5f14('0xff'), 'main_color': '#1a1a1a', 'action_color': '#1a1a1a', 'wheel_dots_color': '#FFFFFF', 'wheel_border_color': a0_0x5f14('0xff'), 'wheel_pointer_color': a0_0x5f14('0x148'), 'wheel_slices_text_color': a0_0x5f14('0x148'), 'wheel_slices_color': __default_slice_colors, 'wheel_lines_size': 0x0 }, 'themes': [] },
        'created': function() {
            var _0x3a0fea = this;
            __WHEEL_DATA__[a0_0x5f14('0x153')] && (!SHARED_DATA['user'] || __WHEEL_DATA__[a0_0x5f14('0x153')] !== SHARED_DATA['user']['id']) && (this[a0_0x5f14('0x112')] = !![], this['mode'] = a0_0x5f14('0x99'), $(a0_0x5f14('0x13b'))['css']('overflow', a0_0x5f14('0xcc'))), __WHEEL_DATA__['id'] && (this[a0_0x5f14('0x63')] = __WHEEL_DATA__['choices'] || [], __WHEEL_DATA__[a0_0x5f14('0x3a')][a0_0x5f14('0xf0')] && (this[a0_0x5f14('0xf0')] = __WHEEL_DATA__[a0_0x5f14('0x3a')][a0_0x5f14('0xf0')]), __WHEEL_DATA__['config'][a0_0x5f14('0x5c')] && (this[a0_0x5f14('0x3a')] = __WHEEL_DATA__[a0_0x5f14('0x3a')][a0_0x5f14('0x5c')]), __WHEEL_DATA__[a0_0x5f14('0x3a')][a0_0x5f14('0xf1')] && (this[a0_0x5f14('0xf0')][a0_0x5f14('0x16')] = __WHEEL_DATA__[a0_0x5f14('0x3a')][a0_0x5f14('0xf1')]), this[a0_0x5f14('0x8d')] = (__WHEEL_DATA__[a0_0x5f14('0x103')] || [])[a0_0x5f14('0x41')]('\x0a'), this[a0_0x5f14('0x5f')] = __WHEEL_DATA__[a0_0x5f14('0x5f')], this[a0_0x5f14('0x104')] = __WHEEL_DATA__), window[a0_0x5f14('0x45')] && (this[a0_0x5f14('0x12a')] = window['__SAVED_WHEELS__']), this['checkUserSubStatus'](), this['onEditBulkEntries'](), this[a0_0x5f14('0x3a')]['advanced_mode'] && (this['wheel_add_option_list'] = __WHEEL_DATA__[a0_0x5f14('0x103')], this['wheel_add_option_list'][a0_0x5f14('0x87')](function(_0x3e2527) { _0x3e2527['chance'] = parseInt(_0x3e2527['chance']); }), this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x11e')][a0_0x5f14('0x158')](function(_0xc183ba) { return _0xc183ba[a0_0x5f14('0x113')]; }), this[a0_0x5f14('0x5b')] = this['participants'][a0_0x5f14('0x41')]('\x0a'), this[a0_0x5f14('0x126')]());
        },
        'computed': { 'is_spin_btn_alone': function() { if (this['config'][a0_0x5f14('0x51')]) return ![]; if (this[a0_0x5f14('0x3a')]['show_title'] && this[a0_0x5f14('0x3a')][a0_0x5f14('0x5f')]) return ![]; if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x30')] && this['config']['description']) return ![]; return !![]; }, 'is_wheel_r_visible': function() { if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')]) return !![]; if (this['config'][a0_0x5f14('0xbe')] && this[a0_0x5f14('0x3a')]['title']) return !![]; if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x30')] && this[a0_0x5f14('0x3a')]['description']) return !![]; if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x1')]) return !![]; return ![]; }, 'can_play_wheel': function() { if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')]) return ![]; return !![]; }, 'should_save_wheel': function() { if (this[a0_0x5f14('0x3a')]['capture_leads']) return !![]; return ![]; } },
        'mounted': function() {
            var _0x2e16c4 = 0x0;
            this[a0_0x5f14('0x15b')] = document['body'][a0_0x5f14('0xa4')] <= 0x400, this[a0_0x5f14('0x15b')] && (this[a0_0x5f14('0x14')] = null, $(a0_0x5f14('0x141'))['removeClass'](a0_0x5f14('0x9c'))[a0_0x5f14('0x15a')]('collapse')), __DATA_WHEEL_THEMES__ && (this[a0_0x5f14('0x163')] = __DATA_WHEEL_THEMES__), this[a0_0x5f14('0x4a')] = new Winwheel({ 'responsive': ![], 'pointerAngle': 0x5a, 'numSegments': 0x0, 'innerRadius': 0x32, 'textFontSize': 0x12, 'textFontFamily': a0_0x5f14('0x4b'), 'textFontWeight': '700', 'textMargin': 0xf, 'textAlignment': a0_0x5f14('0x106'), 'lineWidth': _0x2e16c4, 'strokeStyle': _0x2e16c4 ? a0_0x5f14('0x4f') : null, 'animation': { 'type': a0_0x5f14('0xd1'), 'duration': 0x5, 'spins': 0x8, 'callbackFinished': this[a0_0x5f14('0x102')], 'callbackSound': this['playSound'], 'easing': 'Expo.easeOut' }, 'pins': { 'number': 0xf, 'outerRadius': 0x4, 'margin': 0x7, 'fillStyle': a0_0x5f14('0x4f'), 'strokeStyle': a0_0x5f14('0x59') } }), this[a0_0x5f14('0x6a')](), this[a0_0x5f14('0x73')](), this[a0_0x5f14('0x58')] = this[a0_0x5f14('0x2b')](0x8), this[a0_0x5f14('0x160')](), this[a0_0x5f14('0x3a')][a0_0x5f14('0x46')] === '' && (this[a0_0x5f14('0x3a')][a0_0x5f14('0x46')] = this['$t'](a0_0x5f14('0xec')));
        },
        'methods': {
            'resetValues': function() { this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')] = [null], this[a0_0x5f14('0x4a')][a0_0x5f14('0x80')] = 0x0; },
            'setup': function() {
                var _0x113567 = this;
                this[a0_0x5f14('0xd0')]();
                var _0x4d0788 = 0x0,
                ...
                this[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] === 0x0 && (_0x2d6505 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']), this[a0_0x5f14('0x3a')][a0_0x5f14('0xe3')] && (_0x2d6505[a0_0x5f14('0xaa')] < 0x4 && (_0x2d6505 = _0x2d6505[a0_0x5f14('0xb6')](_0x2d6505)[a0_0x5f14('0xb6')](_0x2d6505)), _0x2d6505[a0_0x5f14('0xaa')] < 0x8 && (_0x2d6505 = _0x2d6505[a0_0x5f14('0xb6')](_0x2d6505))), _0x2d6505[a0_0x5f14('0x87')](function(_0x5aea9b, _0x583228) {
                    ...
                    _0x113567[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x32 && (_0x29a609 = 0xc);
                    _0x113567[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x50 && (_0x29a609 = 0xa);
                    _0x113567[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x8c && (_0x6ea7f2 = '');
                    _0x113567['participants'][a0_0x5f14('0xaa')] > 0x14 && _0x29a609 > 0x1e && (_0x29a609 = 0x1c);
                    _0x113567[a0_0x5f14('0x63')]['length'] > 0x28 && _0x29a609 > 0x14 && (_0x29a609 = 0x16);
                    _0x113567[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x3c && _0x29a609 > 0x12 && (_0x29a609 = 0x12);
                    _0x113567[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x50 && _0x29a609 > 0xe && (_0x29a609 = 0xe);
                    _0x6ea7f2[a0_0x5f14('0xaa')] > 0x14 && (_0x6ea7f2 = _0x6ea7f2[a0_0x5f14('0x8c')](0x0, 0x12) + '..');
                    var _0x4cd83e = a0_0x5f14('0x2');
                    !_0x113567[a0_0x5f14('0xe4')](_0x24c794) && (_0x4cd83e = a0_0x5f14('0xff')), _0x113567['theWheel']['addSegment']({ 'text': _0x6ea7f2, 'originalText': _0x5aea9b, 'fillStyle': _0x24c794, 'textFontSize': _0x29a609, 'textFontFamily': a0_0x5f14('0x4b'), 'textFillStyle': _0x4cd83e });
                }), _0x113567[a0_0x5f14('0x4a')][a0_0x5f14('0x20')](), this['open'] = ![], this['updatePinNumbers'](), this[a0_0x5f14('0xca')](this['design']['wheel_lines_size']);
            },
            'updatePinNumbers': function() { this['theWheel']['pins'][a0_0x5f14('0x6')] = (this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][a0_0x5f14('0xaa')] - 0x1) * 0x1, this['participants'][a0_0x5f14('0xaa')] > 0x32 && (this[a0_0x5f14('0x4a')][a0_0x5f14('0x10e')][a0_0x5f14('0x6')] = 0x0); },
            'getSliceMaxTextLength': function() { var _0x32131a = 0x0; return this['participants'][a0_0x5f14('0x87')](function(_0x218074, _0x5be2b7) { _0x218074['length'] > _0x32131a && (_0x32131a = _0x218074[a0_0x5f14('0xaa')]); }), _0x32131a; },
            'run': function() {
                if (this[a0_0x5f14('0xe8')] === a0_0x5f14('0x21')) return ![];
                if (this['is_wheel_spinning']) return ![];
                this[a0_0x5f14('0x3a')][a0_0x5f14('0xa9')] && this[a0_0x5f14('0x5e')] !== null && (this[a0_0x5f14('0x4a')][a0_0x5f14('0x14f')](this[a0_0x5f14('0x5e')]), this['wheel_add_option_list']['length'] && this[a0_0x5f14('0x11e')][a0_0x5f14('0x5')](this[a0_0x5f14('0x5e')] - 0x1, 0x1), this[a0_0x5f14('0x4a')][a0_0x5f14('0x20')](), this[a0_0x5f14('0x5e')] = null, this[a0_0x5f14('0x29')]()), this[a0_0x5f14('0x28')] = ![], this['is_wheel_spinning'] = !![], this[a0_0x5f14('0x67')] = !![], this[a0_0x5f14('0x3a')][a0_0x5f14('0xd2')] ? TweenMax['to'](a0_0x5f14('0x9a'), 0.5, { 'scale': 1.2, 'x': '0%', 'y': a0_0x5f14('0x50'), 'onComplete': this['spin'] }) : this[a0_0x5f14('0x132')]();
            },
            'spin': function() {
                window[a0_0x5f14('0x127')] && gtag(a0_0x5f14('0x2a'), a0_0x5f14('0x108'), { 'event_category': a0_0x5f14('0xcf') });
                this[a0_0x5f14('0x63')] && this[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] > 0x1 && trackEvent(a0_0x5f14('0xa'), {}, !![]);
                this[a0_0x5f14('0x104')] && this[a0_0x5f14('0x104')]['id'] && this['trackSpin']();
                if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x32')]) var _0xe7d3c5 = this[a0_0x5f14('0xa1')]();
                else var _0xe7d3c5 = this[a0_0x5f14('0x144')]();
                this['theWheel'][a0_0x5f14('0x12f')][a0_0x5f14('0x10d')] = this[a0_0x5f14('0x3a')]['wheel_spin_duration'] || 0xa, this[a0_0x5f14('0x4a')][a0_0x5f14('0x12f')][a0_0x5f14('0x71')] = Math['ceil'](this[a0_0x5f14('0x3a')][a0_0x5f14('0x60')] * 0.6), this[a0_0x5f14('0x4a')]['animation'][a0_0x5f14('0x3f')] = this[a0_0x5f14('0x4a')][a0_0x5f14('0x0')](_0xe7d3c5), this[a0_0x5f14('0x4a')][a0_0x5f14('0x7f')]();
            },
            'getRandomSegmentIndex': function() {
                var _0x4ba488 = this['theWheel']['segments'][a0_0x5f14('0xaa')] - 0x1,
                    _0x2ba33a = rando(0x1, _0x4ba488);
                return this[a0_0x5f14('0xbf')] === _0x2ba33a && (_0x2ba33a = rando(0x1, _0x4ba488)), this[a0_0x5f14('0xbf')] === _0x2ba33a && (_0x2ba33a = rando(0x1, _0x4ba488)), this[a0_0x5f14('0xbf')] = _0x2ba33a, _0x2ba33a;
            },
            'getWeightedRandomSegmentIndex': function() {
                let _0x3a1bb8 = 0x0,
                    _0x49e3eb = 0x0,
                    _0x357ce0 = this;
                this['wheel_add_option_list']['forEach'](function(_0x15e898) { _0x3a1bb8 += _0x15e898['calculated_chance']; }), console[a0_0x5f14('0xb4')](), console['log'](a0_0x5f14('0x8'), _0x3a1bb8);
                ...
                for (const _0xe0dc09 of this[a0_0x5f14('0x11e')]) {
                    _0x1a750d += _0xe0dc09[a0_0x5f14('0xf7')], console[a0_0x5f14('0x13d')]('accumulatedWeight', _0x1a750d);
                    if (_0x307d71 <= _0x1a750d) return console[a0_0x5f14('0x13d')](a0_0x5f14('0x125'), _0x357ce0[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][_0x49e3eb + 0x1][a0_0x5f14('0x113')]), _0x49e3eb + 0x1;
                    _0x49e3eb++;
                }
            ...
            'hex_is_light': function(_0x1fa287) {
                const _0x45b14e = _0x1fa287[a0_0x5f14('0x135')]('#', ''),
                    ...
                    _0x39b3c6 = (_0x164a96 * 0x12b + _0x5407d8 * 0x24b + _0xb7d33c * 0x72) / 0x3e8;
                return _0x39b3c6 > 0x9b;
            },
            'alertPrize': function alertPrize(_0x55e24f) {
                this['is_wheel_spinning'] = ![], this[a0_0x5f14('0xb7')]();
                debugger;
                this[a0_0x5f14('0x24')] = _0x55e24f[a0_0x5f14('0x1c')] || _0x55e24f[a0_0x5f14('0x113')], this['wheel_segment_index'] = this['theWheel']['getIndicatedSegmentNumber']();
                while (this[a0_0x5f14('0x4a')][a0_0x5f14('0x38')] > 0x0) { this[a0_0x5f14('0x4a')][a0_0x5f14('0x38')] -= 0x168; }
                var _0x55a65f = _0x55e24f[a0_0x5f14('0x1c')] || _0x55e24f[a0_0x5f14('0x113')];
                this['results'][a0_0x5f14('0x25')](_0x55a65f), this['config'][a0_0x5f14('0xd2')] && TweenMax['to'](a0_0x5f14('0x9a'), 0.5, { 'scale': 0x1, 'x': '0%', 'y': '0%' }), TweenMax['to'](a0_0x5f14('0x134'), 0.3, { 'scale': 1.5, 'onComplete': function() { TweenMax['to']('.wof__wheel__winner', 0.5, { 'scale': 0x1 }); } }), this[a0_0x5f14('0xe5')](), setTimeout(this[a0_0x5f14('0xe5')], 0x2ee);
            },
            'playSound': function() {
                var _0x1eb6c4 = '.centered-spin';
                _0x1eb6c4 = a0_0x5f14('0x66'), TweenMax['to'](_0x1eb6c4, 0.15, { 'rotation': -0x14, 'onComplete': function() { TweenMax['to'](_0x1eb6c4, 0x0, { 'rotation': 0x0 }); } });
                if (this[a0_0x5f14('0x28')]) return ![];
                var _0xa1ca97 = this[a0_0x5f14('0x4a')]['getIndicatedSegment']();
                this[a0_0x5f14('0x24')] = _0xa1ca97['text'] || _0xa1ca97['originalText'], this[a0_0x5f14('0x3a')]['play_sounds'] && SoundPlayer[a0_0x5f14('0x99')](this[a0_0x5f14('0x3a')][a0_0x5f14('0x118')], {}, ![], !![]);
            },
            'playFxEnd': function() { this['config'][a0_0x5f14('0xf5')] && SoundPlayer[a0_0x5f14('0x99')]('end', {}, ![], !![]);; },
            'toggleSound': function() { this[a0_0x5f14('0x3a')][a0_0x5f14('0xf5')] = !this[a0_0x5f14('0x3a')][a0_0x5f14('0xf5')]; },
            'toggleWinners': function() { this[a0_0x5f14('0x123')] = !this[a0_0x5f14('0x123')]; },
            'toggleFs': function() { screenfull[a0_0x5f14('0xde')]($(a0_0x5f14('0x56'))[0x0])[a0_0x5f14('0x48')](function() { console[a0_0x5f14('0x13d')](a0_0x5f14('0x105') + (screenfull['isFullscreen'] ? a0_0x5f14('0x122') : a0_0x5f14('0x42'))); }); },
            'saveWheel': function() {
                if (this[a0_0x5f14('0x63')][a0_0x5f14('0xaa')] < 0x2) return $(a0_0x5f14('0x154'))[a0_0x5f14('0x52')](a0_0x5f14('0x143')), this[a0_0x5f14('0xa3')](this['$t']('app_wheel.error_no_entries'), 'error');
                if (JSON[a0_0x5f14('0x9')](__default_names) === JSON[a0_0x5f14('0x9')](this['participants'])) return $(a0_0x5f14('0x154'))[a0_0x5f14('0x52')](a0_0x5f14('0x143')), this['toast'](this['$t'](a0_0x5f14('0x70')), a0_0x5f14('0x8f'));
                if (this['user'] === null || !this['user'] || !this['user']['id']) return this[a0_0x5f14('0x11')]['AuthModal'][a0_0x5f14('0x9c')](), this[a0_0x5f14('0x120')] = !![], ![];
                if (this[a0_0x5f14('0x104')] && this[a0_0x5f14('0x104')]['id']) return this[a0_0x5f14('0x47')]();
                $(a0_0x5f14('0xa7'))['modal']();
            },
            'onSaveLeadsWheel': function() {
                var _0x8c4845 = this;
                if (this['config'][a0_0x5f14('0x51')]) {
                    this[a0_0x5f14('0x3a')]['name'] = _0x8c4845['save_form'][a0_0x5f14('0x11a')];
                    var _0x358830 = this['config'],
                        _0x54ca0a = this[a0_0x5f14('0xf0')],
                        _0x5a047b = this[a0_0x5f14('0x31')];
                    return this[a0_0x5f14('0xd9')] = !![], this[a0_0x5f14('0x53')](a0_0x5f14('0xd'), this[a0_0x5f14('0x78')][a0_0x5f14('0x11a')], _0x358830, _0x54ca0a, _0x5a047b, function(_0x549d37) { _0x549d37[a0_0x5f14('0xf4')] && _0x549d37[a0_0x5f14('0x10c')]['id'] ? (trackEvent(a0_0x5f14('0xcd')), window[a0_0x5f14('0x77')][a0_0x5f14('0xdc')] = '/promotions/setup/' + _0x549d37[a0_0x5f14('0x10c')]['id'] + a0_0x5f14('0xf6')) : (_0x549d37[a0_0x5f14('0x10c')] === a0_0x5f14('0x8a') ? ($(a0_0x5f14('0xa7'))['modal'](a0_0x5f14('0xe0')), _0x8c4845[a0_0x5f14('0x11')][a0_0x5f14('0xb9')][a0_0x5f14('0x9c')]()) : _0x8c4845[a0_0x5f14('0xa3')](a0_0x5f14('0x15'), 'error'), _0x8c4845[a0_0x5f14('0xd9')] = ![]); }), ![];
                }
            },
            'onSaveWheel': function(_0x20f269) {
                ...
                this[a0_0x5f14('0x3a')]['advanced_mode'] && (_0xc21e62 = this[a0_0x5f14('0x11e')]), $[a0_0x5f14('0xf9')]({
                    'url': a0_0x5f14('0x13c'),
                    'method': 'POST',
                    'dataType': 'json',
                    'data': { 'id': _0x235dc8[a0_0x5f14('0x104')] && _0x235dc8['savedWheel']['id'] ? _0x235dc8[a0_0x5f14('0x104')]['id'] : null, 'title': _0x235dc8['save_form'][a0_0x5f14('0x11a')] || _0x235dc8[a0_0x5f14('0x5f')], 'choices': _0xc21e62, 'version': 0x2, 'lang': window[a0_0x5f14('0x14c')] ? window[a0_0x5f14('0x14c')] : '', 'promotion_id': _0x20f269 || null, 'config': { 'settings': _0x235dc8[a0_0x5f14('0x3a')], 'design': _0x235dc8['design'] } },
                    'success': function(_0x1bbc3a) {
                        if (!_0x235dc8[a0_0x5f14('0x104')]['id']) return mixpanel['track']('AS_SavedWheel'), window['location']['href'] = window['location'][a0_0x5f14('0xdc')][a0_0x5f14('0x135')]('#', '') + a0_0x5f14('0x101') + _0x1bbc3a[a0_0x5f14('0x10c')][a0_0x5f14('0x65')], ![];
                        mixpanel['track'](a0_0x5f14('0xfc')), _0x235dc8['saving'] = ![], _0x235dc8[a0_0x5f14('0x104')] = _0x1bbc3a[a0_0x5f14('0x10c')], _0x235dc8['toast'](_0x235dc8['$t'](a0_0x5f14('0x93')));
                    },
                    'error': function(_0x4831ea, _0x1d83f4, _0x4386ed) { _0x235dc8[a0_0x5f14('0xd9')] = ![], console[a0_0x5f14('0x13d')]('Error:\x20', _0x4386ed); }
                });
            },
            'hex2RGBA': function(_0x52ca82, _0x3e5607) { return _0x52ca82 = _0x52ca82['replace']('#', ''), r = parseInt(_0x52ca82[a0_0x5f14('0x14d')](0x0, 0x2), 0x10), g = parseInt(_0x52ca82[a0_0x5f14('0x14d')](0x2, 0x4), 0x10), b = parseInt(_0x52ca82['substring'](0x4, 0x6), 0x10), result = a0_0x5f14('0x61') + r + ',' + g + ',' + b + ',' + _0x3e5607 / 0x64 + ')', result; },
            'getFontSize': function(_0x1f99bc) { var _0x4e7853 = _0x1f99bc; if (this['is_wheel_spinning']) return '100%'; if (_0x4e7853['length'] > 0x3c) return a0_0x5f14('0xfe'); if (_0x4e7853['length'] > 0x2e) return a0_0x5f14('0xa6'); if (_0x4e7853[a0_0x5f14('0xaa')] > 0x24) return a0_0x5f14('0x44'); return a0_0x5f14('0x3e'); },
            'usePalette': function(_0x4ff7a2) {
                var _0x3e5361 = 0x0;
                this[a0_0x5f14('0xf1')] = _0x4ff7a2, this[a0_0x5f14('0xf0')]['wheel_slices_color'] = _0x4ff7a2;
                for (i = 0x0; i < this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][a0_0x5f14('0xaa')]; i++) {
                    if (this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][i] && this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][i]['fillStyle']) {
                        var _0x1b5eb9 = this['design'][a0_0x5f14('0x16')][_0x3e5361];
                        _0x3e5361++;
                        if (_0x3e5361 > this[a0_0x5f14('0xf0')][a0_0x5f14('0x16')]['length'] - 0x1) _0x3e5361 = 0x0;
                        this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][i]['fillStyle'] = _0x1b5eb9;
                        var _0x59088e = a0_0x5f14('0x11f');
                        !this[a0_0x5f14('0xe4')](_0x1b5eb9) && (_0x59088e = '#f5f5f5'), this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][i]['textFillStyle'] = _0x59088e;
                    }
                }
                this['theWheel'][a0_0x5f14('0x20')]();
            },
            'editColors': function() { this[a0_0x5f14('0x40')](a0_0x5f14('0xfb')); },
            'onDeleteWheel': function(_0x17ad10) { this[a0_0x5f14('0xc5')](this['$t'](a0_0x5f14('0x72')), this['$t'](a0_0x5f14('0x3')), this['$t']('buttons.delete'), this[a0_0x5f14('0x22')]); },
            'onItemDeleted': function() { $['ajax']({ 'method': a0_0x5f14('0x2d'), 'dataType': a0_0x5f14('0x13e'), 'url': a0_0x5f14('0xc1'), 'data': { 'id': this[a0_0x5f14('0x104')]['id'] }, 'success': function(_0x53fee7) { window[a0_0x5f14('0x77')][a0_0x5f14('0xdc')] = a0_0x5f14('0x96'); }, 'error': function(_0x498e50, _0x549b8d, _0x3018e1) {} }); },
            'spinWhileWaiting': function() { this[a0_0x5f14('0x28')] = !![], this[a0_0x5f14('0x4a')][a0_0x5f14('0x12f')][a0_0x5f14('0x71')] = 0x1e, this[a0_0x5f14('0x4a')]['animation']['duration'] = 0x78 * 0x64, this['theWheel'][a0_0x5f14('0x7f')](); },
            'onLogoSelected': function(_0x1ff069) {
                var _0x7aa69f = this;
                if (_0x1ff069[a0_0x5f14('0x4e')]['files'][a0_0x5f14('0xaa')]) {
                    var _0x31484c = new FileReader();
                    _0x31484c[a0_0x5f14('0x2c')] = function(_0x1d2262) { _0x7aa69f[a0_0x5f14('0xf0')][a0_0x5f14('0x136')] = _0x1d2262[a0_0x5f14('0x4e')]['result'], mixpanel[a0_0x5f14('0x74')](a0_0x5f14('0xdd'), { 'action': a0_0x5f14('0x9b') }), _0x7aa69f[a0_0x5f14('0xe')](_0x1d2262[a0_0x5f14('0x4e')][a0_0x5f14('0x64')], 0x1f4, 0x1f4, function(_0x19bf3e) { _0x7aa69f[a0_0x5f14('0xf0')][a0_0x5f14('0x136')] = _0x19bf3e; }); }, _0x31484c[a0_0x5f14('0x1d')](_0x1ff069[a0_0x5f14('0x4e')]['files'][0x0]);
                }
            },
            'resizeDownDataUrlKeepProportions': function(_0xfa4bf7, _0x5cc116, _0x398a9e, _0x595896, _0x2735f6) {
                ...
                _0x28a848[a0_0x5f14('0xd4')](a0_0x5f14('0x3b'), function() {
                    ...
                    if (_0x28a848[a0_0x5f14('0x39')] > _0x5cc116 || _0x28a848['height'] > _0x398a9e) {
                        if (_0x28a848[a0_0x5f14('0x39')] == _0x28a848[a0_0x5f14('0x2f')]) _0x3ed4e9[a0_0x5f14('0x39')] = _0x398a9e >= _0x5cc116 ? _0x5cc116 : _0x398a9e, _0x3ed4e9[a0_0x5f14('0x2f')] = _0x398a9e >= _0x5cc116 ? _0x5cc116 : _0x398a9e;
                        else {
                            if (_0x28a848[a0_0x5f14('0x39')] > _0x28a848[a0_0x5f14('0x2f')]) _0x3ed4e9[a0_0x5f14('0x39')] = _0x5cc116, _0x3ed4e9['height'] = _0x5cc116 / _0x28a848[a0_0x5f14('0x39')] * _0x28a848[a0_0x5f14('0x2f')];
                            else _0x28a848[a0_0x5f14('0x2f')] > _0x28a848[a0_0x5f14('0x39')] && (_0x3ed4e9[a0_0x5f14('0x2f')] = _0x398a9e, _0x3ed4e9[a0_0x5f14('0x39')] = _0x398a9e / _0x28a848[a0_0x5f14('0x2f')] * _0x28a848[a0_0x5f14('0x39')]);
                        }
                    } else return ![];
                    _0x461af1[a0_0x5f14('0x110')](this, 0x0, 0x0, _0x3ed4e9[a0_0x5f14('0x39')], _0x3ed4e9[a0_0x5f14('0x2f')]);
                    var _0x260e54 = _0x3ed4e9[a0_0x5f14('0xbb')](a0_0x5f14('0x3d'), _0x2735f6);
            ...
            'onBackgroundSelected': function(_0x3cb31e) {
                ...
                if (_0x3cb31e[a0_0x5f14('0x4e')][a0_0x5f14('0x82')]['length']) {
                    ...
                    _0x76071a[a0_0x5f14('0x2c')] = function(_0x3df06c) { _0x3027f5[a0_0x5f14('0xf0')]['page_background_image'] = _0x3df06c[a0_0x5f14('0x4e')][a0_0x5f14('0x64')], mixpanel['track']('AS_WheelUserAction', { 'action': a0_0x5f14('0x17') }), _0x3027f5[a0_0x5f14('0xe')](_0x3df06c[a0_0x5f14('0x4e')]['result'], 0x780, 0x438, function(_0x450166) { _0x3027f5[a0_0x5f14('0xf0')][a0_0x5f14('0x1a')] = _0x450166; }); }, _0x76071a[a0_0x5f14('0x1d')](_0x3cb31e[a0_0x5f14('0x4e')]['files'][0x0]);
                }
            },
            'onLaunchWheel': function() {
                if (this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')]) return ![];
                var _0x2289c4 = this;
                this[a0_0x5f14('0xe8')] = 'play', window[a0_0x5f14('0x7d')][a0_0x5f14('0x11b')](a0_0x5f14('0xd3'), null, null), window[a0_0x5f14('0xd4')](a0_0x5f14('0x1e'), function(_0xbaf73c) { _0x2289c4[a0_0x5f14('0x128')](); }, { 'once': !![] }), this[a0_0x5f14('0x152')](0x3e8), this[a0_0x5f14('0x2e')] = this[a0_0x5f14('0x11e')][a0_0x5f14('0x8c')](0x0), $(a0_0x5f14('0x13b'))[a0_0x5f14('0xc2')](a0_0x5f14('0x147'), 'hidden'), this[a0_0x5f14('0x63')] && this['participants'][a0_0x5f14('0xaa')] > 0x1 && !this[a0_0x5f14('0x104')]['id'] && (JSON[a0_0x5f14('0x9')](__default_names) !== JSON['stringify'](this[a0_0x5f14('0x63')]) && trackEvent(a0_0x5f14('0xb2'), {}, !![]));
            },
            'getWheelStyles': function(_0x595b63) {
                switch (_0x595b63) {
                    case 'page':
                        var _0x382145 = { 'backgroundColor': this[a0_0x5f14('0xf0')][a0_0x5f14('0x149')], 'color': this['design'][a0_0x5f14('0xba')] };
                        this['design'][a0_0x5f14('0x1a')] && (_0x382145[a0_0x5f14('0xfd')] = 'url(' + this[a0_0x5f14('0xf0')][a0_0x5f14('0x1a')] + ')', _0x382145[a0_0x5f14('0xc')] = a0_0x5f14('0x49'), _0x382145['backgroundRepeat'] = a0_0x5f14('0x94'), this[a0_0x5f14('0xf0')]['page_background_image']['indexOf']('/patterns/') > -0x1 && (_0x382145['backgroundSize'] = a0_0x5f14('0x161'), _0x382145[a0_0x5f14('0x151')] = 'repeat'));
                        return _0x382145;
                    case a0_0x5f14('0x8b'):
                    ...
                    case 'spin-btn':
                        return { 'backgroundColor': this[a0_0x5f14('0xf0')][a0_0x5f14('0xba')], 'color': this[a0_0x5f14('0xe4')](this[a0_0x5f14('0xf0')][a0_0x5f14('0xba')]) ? a0_0x5f14('0x55') : a0_0x5f14('0xff') };
                    case a0_0x5f14('0x15d'):
                        return { 'backgroundColor': this[a0_0x5f14('0xf0')][a0_0x5f14('0xba')], 'color': this[a0_0x5f14('0xe4')](this['design'][a0_0x5f14('0xba')]) ? a0_0x5f14('0x55') : '#FFFFFF', 'max-width': a0_0x5f14('0xe2'), 'margin-top': a0_0x5f14('0x50') };
                    case a0_0x5f14('0xf8'):
                        return { 'color': this[a0_0x5f14('0xe4')](this[a0_0x5f14('0xf0')]['main_color']) ? a0_0x5f14('0x55') : a0_0x5f14('0xff') };
                }
            },
            'onDesignPropChanged': function(_0x540213, _0x40ca12, _0x459cab) {
                var _0x5453ec = this;
                _0x40ca12 === a0_0x5f14('0x84') && (this[a0_0x5f14('0x4a')]['strokeStyle'] = _0x540213['target']['value'], this[a0_0x5f14('0x4a')][a0_0x5f14('0x20')]());
                _0x40ca12 === 'wheel_slices_text_color' && (this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')][a0_0x5f14('0x87')](function(_0x377c18) { _0x377c18 && _0x377c18[a0_0x5f14('0x13a')] && (_0x377c18['textFillStyle'] = _0x540213[a0_0x5f14('0x4e')][a0_0x5f14('0x62')]); }), this[a0_0x5f14('0x4a')][a0_0x5f14('0x20')]());
                _0x40ca12 === a0_0x5f14('0x69') && this[a0_0x5f14('0xca')](parseInt(_0x540213[a0_0x5f14('0x4e')][a0_0x5f14('0x62')]));
                if (_0x40ca12 === a0_0x5f14('0x16')) {
                    console[a0_0x5f14('0x13d')](_0x40ca12, _0x459cab);
                    var _0x34cc57 = 0x0;
                    this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')]['forEach'](function(_0x1ecd46) { _0x1ecd46 && (_0x34cc57 === _0x459cab && (_0x1ecd46[a0_0x5f14('0x12d')] = _0x540213['target']['value']), _0x34cc57++), _0x34cc57 >= _0x5453ec[a0_0x5f14('0xf0')][a0_0x5f14('0x16')][a0_0x5f14('0xaa')] && (_0x34cc57 = 0x0); }), this[a0_0x5f14('0x4a')][a0_0x5f14('0x20')]();
                }
            },
            'updateWheelStroke': function(_0x44c26a) { _0x44c26a = parseInt(_0x44c26a), this[a0_0x5f14('0x4a')][a0_0x5f14('0xee')] = _0x44c26a, _0x44c26a === 0x0 ? this[a0_0x5f14('0x4a')][a0_0x5f14('0x10f')] = null : this['theWheel']['strokeStyle'] = this[a0_0x5f14('0xf0')]['wheel_border_color'], this[a0_0x5f14('0x4a')][a0_0x5f14('0x20')](); },
            'onSelectTab': function(_0x274d94) { this[a0_0x5f14('0x15b')] && (this[a0_0x5f14('0xce')] = !![]), _0x274d94 === 'config' && $(a0_0x5f14('0x33'))[a0_0x5f14('0x52')](a0_0x5f14('0x143')), _0x274d94 === 'prizes' && $('[data-target=\x22#Customizer_Section_Prizes\x22]')['trigger'](a0_0x5f14('0x143')), _0x274d94 === a0_0x5f14('0xf0') && $('[data-target=\x22#Customizer_Section_Design\x22]')[a0_0x5f14('0x52')](a0_0x5f14('0x143')), this[a0_0x5f14('0x14')] = _0x274d94, this[a0_0x5f14('0x152')](0x190); },
            'useTheme': function(_0x4ff861) { this[a0_0x5f14('0xf0')][a0_0x5f14('0x149')] = _0x4ff861['page_background_color'], this[a0_0x5f14('0xf0')]['main_color'] = _0x4ff861[a0_0x5f14('0xba')], this[a0_0x5f14('0xf0')][a0_0x5f14('0x109')] = _0x4ff861['action_color'], this['design'][a0_0x5f14('0x89')] = _0x4ff861[a0_0x5f14('0x89')], this[a0_0x5f14('0xf0')][a0_0x5f14('0x84')] = _0x4ff861[a0_0x5f14('0x84')], this[a0_0x5f14('0xf0')][a0_0x5f14('0x12')] = _0x4ff861[a0_0x5f14('0x12')], this[a0_0x5f14('0xf0')]['wheel_slices_color'] = _0x4ff861[a0_0x5f14('0x16')], this[a0_0x5f14('0xf0')]['wheel_slices_text_color'] = _0x4ff861[a0_0x5f14('0xd6')], this[a0_0x5f14('0xdb')](), this[a0_0x5f14('0xca')](this[a0_0x5f14('0xf0')][a0_0x5f14('0x69')]), mixpanel[a0_0x5f14('0x74')](a0_0x5f14('0xdd'), { 'action': a0_0x5f14('0x9f') }); },
            'refreshSliceColors': function() {
                var _0x14ac01 = this,
                    _0x4345fc = 0x0;
                this[a0_0x5f14('0x4a')][a0_0x5f14('0x130')]['forEach'](function(_0x56ef2a) { _0x56ef2a && (_0x56ef2a[a0_0x5f14('0x12d')] = _0x14ac01['design'][a0_0x5f14('0x16')][_0x4345fc], _0x14ac01[a0_0x5f14('0xf0')][a0_0x5f14('0xd6')] === a0_0x5f14('0xb8') ? _0x56ef2a[a0_0x5f14('0x13a')] = _0x14ac01[a0_0x5f14('0xe4')](_0x56ef2a[a0_0x5f14('0x12d')]) ? '#1A1A1A' : a0_0x5f14('0xff') : _0x56ef2a[a0_0x5f14('0x13a')] = _0x14ac01[a0_0x5f14('0xf0')][a0_0x5f14('0xd6')], _0x4345fc++), _0x4345fc >= _0x14ac01[a0_0x5f14('0xf0')][a0_0x5f14('0x16')]['length'] && (_0x4345fc = 0x0); }), this['theWheel'][a0_0x5f14('0x20')]();
            },
            'onWheelOptionsChanged': function() {
                var _0x5b87e6 = this[a0_0x5f14('0x5b')][a0_0x5f14('0x54')]('\x0a')[a0_0x5f14('0x68')](function(_0x26c5bb) { return _0x26c5bb !== ''; })['map'](function(_0x4d3754) { return _0x4d3754['trim'](); });
                this[a0_0x5f14('0x63')] = _0x5b87e6, this[a0_0x5f14('0x6a')]();
            },
            'onAddOptionToWheel': function() {
                var _0x53c3f3 = this[a0_0x5f14('0x155')][a0_0x5f14('0x54')]('\x0a')['filter'](function(_0xadf625) { return _0xadf625 !== ''; })[a0_0x5f14('0x158')](function(_0x3b7b6e) { return _0x3b7b6e[a0_0x5f14('0xbd')](); }),
                    _0x5ed7c5 = this[a0_0x5f14('0x1b')][a0_0x5f14('0xbd')]();
                _0x5ed7c5 && (this[a0_0x5f14('0x63')]['push'](_0x5ed7c5), this[a0_0x5f14('0x1b')] = ''), this[a0_0x5f14('0x6a')]();
            },
            'initKeyHandlers': function() {
                var _0x2966a5 = this;
                window[a0_0x5f14('0xd4')]('keydown', function(_0x45f580) {
                    if (_0x2966a5[a0_0x5f14('0xe8')] !== a0_0x5f14('0x99')) return ![];
                    (_0x45f580[a0_0x5f14('0xd8')] === 0x1b || _0x45f580[a0_0x5f14('0xd8')] === 0xd) && (_0x45f580[a0_0x5f14('0x26')](), _0x2966a5['onStopPlaying']()), _0x45f580[a0_0x5f14('0xd8')] === 0x20 && (_0x45f580[a0_0x5f14('0x26')](), _0x2966a5[a0_0x5f14('0x36')]());
                });
            },
            'fireConfettis': function() {
                if (this[a0_0x5f14('0x129')] === null) {
                    var _0x3fb5a3 = document[a0_0x5f14('0xea')](a0_0x5f14('0x15e'));
                    _0x3fb5a3 ? this[a0_0x5f14('0x129')] = new JSConfetti({ 'canvas': _0x3fb5a3 }) : this['jsConfetti'] = new JSConfetti();
                }
                this[a0_0x5f14('0x3a')][a0_0x5f14('0xf3')] && this['jsConfetti'][a0_0x5f14('0x142')]({ 'confettiRadius': 0x4 });
            },
            'onShowConfettisChange': function() { this[a0_0x5f14('0x3a')]['show_confettis'] && this[a0_0x5f14('0xe5')](); },
            'onPlaySoundsChange': function() { this[a0_0x5f14('0x3a')][a0_0x5f14('0xf5')] && SoundPlayer['play'](this[a0_0x5f14('0x3a')][a0_0x5f14('0x118')]); },
            'onStopPlaying': function() {
                if (this['is_wheel_spinning']) return ![];
                if (this[a0_0x5f14('0x112')]) return ![];
                this[a0_0x5f14('0x6a')](), setTimeout(() => this[a0_0x5f14('0x67')] = ![], 0x7), this[a0_0x5f14('0x11e')] = this[a0_0x5f14('0x2e')], this['wheel_segment_index'] = null, this['wheel_segment_name'] = null, this['results'] = [], this[a0_0x5f14('0xe8')] = a0_0x5f14('0x21'), $(a0_0x5f14('0x13b'))[a0_0x5f14('0xc2')](a0_0x5f14('0x147'), 'auto');
            },
            'toggleFullScreen': function() {
                var _0x4c76ac = this;
                if (screenfull[a0_0x5f14('0xad')]) {
                    var _0x44cc77 = $(a0_0x5f14('0xda'))[0x0];
                    screenfull[a0_0x5f14('0xde')](_0x44cc77), screenfull['on'](a0_0x5f14('0xe1'), function() { _0x4c76ac[a0_0x5f14('0xb3')] = screenfull[a0_0x5f14('0x6f')], screenfull[a0_0x5f14('0x6f')] && trackEvent(a0_0x5f14('0xdd'), { 'action': 'Go_FullScreen' }, !![]); });
                }
            },
            'onRemoveEntry': function(_0x59c481) { this[a0_0x5f14('0x63')][_0x59c481] && (this['participants'][a0_0x5f14('0x5')](_0x59c481, 0x1), this[a0_0x5f14('0x6a')]()); },
            'onEditBulkEntries': function() { this[a0_0x5f14('0x5b')] = this['participants'][a0_0x5f14('0x41')]('\x0a'), this[a0_0x5f14('0x159')] = !![]; },
            'onEditBulkEntriesSave': function() { this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x5b')][a0_0x5f14('0x54')]('\x0a')[a0_0x5f14('0x68')](function(_0x132700) { return _0x132700 !== ''; })[a0_0x5f14('0x158')](function(_0x31ecf7) { return _0x31ecf7[a0_0x5f14('0xbd')](); }), this[a0_0x5f14('0x159')] = ![], this[a0_0x5f14('0x6a')](); },
            'resetPlayWheel': function() { this[a0_0x5f14('0xed')] = [], this['wheel_segment_index'] = null, this['wheel_segment_name'] = null, this[a0_0x5f14('0x67')] = ![], this[a0_0x5f14('0x6a')](); },
            'closeCustomizer': function() { this[a0_0x5f14('0xce')] = ![], this[a0_0x5f14('0x14')] = null, $(a0_0x5f14('0xa5'))[a0_0x5f14('0xa2')](a0_0x5f14('0x9c'))[a0_0x5f14('0x15a')](a0_0x5f14('0x14e')); },
            ...
            'onUserSignup': function(_0x409dee) {
                this[a0_0x5f14('0x11')][a0_0x5f14('0xb9')]['hide'](), $('.hide-logged-in')[a0_0x5f14('0xe0')](), $(a0_0x5f14('0xb'))[a0_0x5f14('0x9c')](), $('.user-picture')[a0_0x5f14('0x91')](a0_0x5f14('0x35'), _0x409dee[a0_0x5f14('0x11c')][a0_0x5f14('0x157')]), this[a0_0x5f14('0x7b')](_0x409dee[a0_0x5f14('0x11c')]), this[a0_0x5f14('0x10a')]();
                if (!this['is_customer'] && this[a0_0x5f14('0xbc')]) return this['showClassicWheelUpgrade'](this[a0_0x5f14('0xbc')]);
                this[a0_0x5f14('0x120')] && this[a0_0x5f14('0x14b')]();
            },
            'onUserLogin': function(_0x579fe6) {
                this[a0_0x5f14('0x88')](a0_0x5f14('0x34')), $(a0_0x5f14('0x6d'))[a0_0x5f14('0xe0')](), $(a0_0x5f14('0xb'))[a0_0x5f14('0x9c')](), $(a0_0x5f14('0xe7'))['attr'](a0_0x5f14('0x35'), _0x579fe6[a0_0x5f14('0x11c')][a0_0x5f14('0x157')]), this['setUser'](_0x579fe6[a0_0x5f14('0x11c')]), this[a0_0x5f14('0xa3')](this['$t'](a0_0x5f14('0x137')), a0_0x5f14('0xf4')), this['checkUserSubStatus']();
                if (!this[a0_0x5f14('0xdf')] && this[a0_0x5f14('0xbc')]) return this[a0_0x5f14('0x76')](this['show_upgrade_after_login']);
                this['show_save_modal_after_login'] && this[a0_0x5f14('0x14b')]();
            },
            'trackSpin': function() { $['post']({ 'url': a0_0x5f14('0x7e') + Date[a0_0x5f14('0xac')](), 'dataType': a0_0x5f14('0x13e'), 'data': { 'id': this['savedWheel']['id'], 'event': 'spin' } }); },
            'trackUniquePageView': function() { $[a0_0x5f14('0x95')]({ 'url': a0_0x5f14('0x7e') + Date[a0_0x5f14('0xac')](), 'dataType': a0_0x5f14('0x13e'), 'data': { 'id': this[a0_0x5f14('0x104')]['id'], 'event': a0_0x5f14('0x4d') } }); },
            'copyWheelLink': function(_0x3040da) {
                if (!this[a0_0x5f14('0x104')][a0_0x5f14('0xaf')]) return ![];
                this['copyToClipboard'](this[a0_0x5f14('0x104')][a0_0x5f14('0xaf')], a0_0x5f14('0x90')), this[a0_0x5f14('0xa3')](this['$t'](a0_0x5f14('0x13f')), a0_0x5f14('0xf4'), 0xdac);
            },
            'onWheelPreviewClick': function() { this[a0_0x5f14('0xe8')] === a0_0x5f14('0x21') && (this[a0_0x5f14('0x162')](), mixpanel[a0_0x5f14('0x74')](a0_0x5f14('0xdd'), { 'action': a0_0x5f14('0x100') })); },
            'onCreateNew': function() { window[a0_0x5f14('0x77')][a0_0x5f14('0xdc')] = this[a0_0x5f14('0x156')]('wheel'), mixpanel[a0_0x5f14('0x74')]('AS_WheelUserAction', { 'action': a0_0x5f14('0x6c') }); },
            'onActivateLeadsWheel': function() { this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')] = !![], this[a0_0x5f14('0x18')](), this['hideModal']('LeadsWheelExplainModal'); },
            'setCaptureLeads': function(_0x3ac88d) {
                if (_0x3ac88d) { this[a0_0x5f14('0x40')]('LeadsWheelExplainModal'); return; }
                this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')] = _0x3ac88d, this[a0_0x5f14('0x18')]();
            },
            'onCaptureLeadsChange': function() { this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')] ? (this['config']['show_start_button'] = !![], (!this[a0_0x5f14('0x3a')][a0_0x5f14('0xbe')] || this['config'][a0_0x5f14('0x5f')] === '') && (this[a0_0x5f14('0x3a')][a0_0x5f14('0xbe')] = !![], this[a0_0x5f14('0x3a')][a0_0x5f14('0x5f')] = this['$t'](a0_0x5f14('0x139'))), (!this[a0_0x5f14('0x3a')][a0_0x5f14('0x30')] || this[a0_0x5f14('0x3a')][a0_0x5f14('0x12e')] === '') && (this['config'][a0_0x5f14('0x30')] = !![], this['config']['description'] = this['$t'](a0_0x5f14('0x10'))), this['createPrizes'](), this[a0_0x5f14('0x6b')] = this[a0_0x5f14('0x63')], this['participants'] = this[a0_0x5f14('0xc8')](), this['is_editing_bulk'] = ![], this[a0_0x5f14('0x6a')](), $(a0_0x5f14('0x154'))['trigger'](a0_0x5f14('0x143')), trackEvent(a0_0x5f14('0xcb'))) : (this['config'][a0_0x5f14('0x1')] = ![], this[a0_0x5f14('0x3a')][a0_0x5f14('0x51')] = ![], this[a0_0x5f14('0x3a')][a0_0x5f14('0xbe')] && this[a0_0x5f14('0x3a')][a0_0x5f14('0x5f')] === this['$t'](a0_0x5f14('0x139')) && (this[a0_0x5f14('0x3a')][a0_0x5f14('0xbe')] = ![], this[a0_0x5f14('0x3a')]['title'] = ''), this[a0_0x5f14('0x3a')]['show_desc'] && this[a0_0x5f14('0x3a')][a0_0x5f14('0x12e')] === this['$t'](a0_0x5f14('0x10')) && (this[a0_0x5f14('0x3a')][a0_0x5f14('0x30')] = ![], this['config'][a0_0x5f14('0x12e')] = ''), $(a0_0x5f14('0xf'))[a0_0x5f14('0x91')]('checked', ![]), this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x6b')], this['onEditBulkEntries'](), this[a0_0x5f14('0x6a')](), this[a0_0x5f14('0x31')] = []); },
            'createPrizes': function() {
                var _0x3f2b05 = this;
                if (JSON['stringify'](__default_names) === JSON[a0_0x5f14('0x9')](this['participants'])) this[a0_0x5f14('0x31')] = [{ 'name': this['$t'](a0_0x5f14('0x43')) + '\x201', 'type': 'text' }, { 'name': this['$t']('app_wheel.default_prize_empty_1'), 'type': a0_0x5f14('0x12b') }, { 'name': this['$t'](a0_0x5f14('0x43')) + '\x202', 'type': 'text' }, { 'name': this['$t'](a0_0x5f14('0x27')), 'type': a0_0x5f14('0x12b') }, { 'name': this['$t'](a0_0x5f14('0x43')) + '\x203', 'type': a0_0x5f14('0x113') }, { 'name': this['$t']('app_wheel.default_prize_empty_3'), 'type': 'empty' }, { 'name': this['$t']('app_wheel.default_prize_text') + '\x204', 'type': a0_0x5f14('0x113') }, { 'name': this['$t'](a0_0x5f14('0xab')), 'type': 'empty' }, { 'name': this['$t'](a0_0x5f14('0x43')) + '\x205', 'type': 'text' }, { 'name': this['$t'](a0_0x5f14('0xc3')), 'type': 'empty' }, { 'name': this['$t'](a0_0x5f14('0x43')) + '\x206', 'type': a0_0x5f14('0x113') }, { 'name': this['$t'](a0_0x5f14('0x27')), 'type': a0_0x5f14('0x12b') }];
                else {
                    var _0x353607 = this[a0_0x5f14('0x63')]['slice'](0x0, 0xa);
                    this[a0_0x5f14('0x31')] = [], _0x353607['forEach'](function(_0x323b3f) {
                        var _0x572dce = { 'name': _0x323b3f, 'type': 'text' };
                        _0x3f2b05['prizes']['push'](_0x572dce);
                    }), this[a0_0x5f14('0x31')][a0_0x5f14('0x25')]({ 'name': this['$t']('app_wheel.default_prize_empty_1'), 'type': 'empty' }), this[a0_0x5f14('0x31')][a0_0x5f14('0x25')]({ 'name': this['$t'](a0_0x5f14('0x27')), 'type': a0_0x5f14('0x12b') });
                }
            },
            'onInputPrizeChange': function() { this[a0_0x5f14('0x63')] = this[a0_0x5f14('0xc8')](), this['setup'](); },
            'getParticipantsListFromPrizes': function() { return this[a0_0x5f14('0x31')][a0_0x5f14('0x158')](function(_0x43e690) { return _0x43e690['name']; }); },
            'shuffle': function(_0x5ed005) { var _0x50b7e0, _0x5261f9, _0x5a29fe; for (_0x5a29fe = _0x5ed005[a0_0x5f14('0xaa')] - 0x1; _0x5a29fe > 0x0; _0x5a29fe--) { _0x50b7e0 = Math[a0_0x5f14('0xfa')](Math[a0_0x5f14('0x116')]() * (_0x5a29fe + 0x1)), _0x5261f9 = _0x5ed005[_0x5a29fe], _0x5ed005[_0x5a29fe] = _0x5ed005[_0x50b7e0], _0x5ed005[_0x50b7e0] = _0x5261f9; } return _0x5ed005; },
            'onSortEntrants': function() { this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x63')][a0_0x5f14('0x14a')](), this[a0_0x5f14('0xb5')] === 'az' ? (this['participants'] = this[a0_0x5f14('0x63')]['sort']()['reverse'](), this['last_sort'] = 'za') : (this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x63')][a0_0x5f14('0x14a')](), this[a0_0x5f14('0xb5')] = 'az'), this[a0_0x5f14('0x117')](), this[a0_0x5f14('0x6a')](); },
            'onShuffleEntrants': function() { this[a0_0x5f14('0x63')] = this[a0_0x5f14('0x97')](this[a0_0x5f14('0x63')]), this['onEditBulkEntries'](), this['setup'](); },
            'onClearEntrants': function() { this[a0_0x5f14('0x63')] = [], this['onEditBulkEntries'](), this[a0_0x5f14('0x6a')](), this[a0_0x5f14('0x3a')]['advanced_mode'] && this[a0_0x5f14('0x11e')][a0_0x5f14('0x87')](function(_0x40807e) { _0x40807e[a0_0x5f14('0x113')] = ''; }); },
            'openMediaGallery': function(_0x355a97) {
                if (!this['is_customer']) return this[a0_0x5f14('0x76')](a0_0x5f14('0xc6'));
                this[a0_0x5f14('0x11')][a0_0x5f14('0x140')][a0_0x5f14('0x85')](_0x355a97);
            },
            'onImageSelected': function(_0x1d4d9f) { _0x1d4d9f[a0_0x5f14('0xef')] && _0x1d4d9f['options']['target'] === a0_0x5f14('0x1a') && (this['design'][a0_0x5f14('0x1a')] = _0x1d4d9f[a0_0x5f14('0xe6')]); },
            'getWheelLink': function(_0x4594d4) { return window['SHARED_DATA']['links']['wheel'] + a0_0x5f14('0x101') + _0x4594d4[a0_0x5f14('0x65')]; },
            'onUploadLogo': function() {
                if (!this[a0_0x5f14('0xdf')]) return this[a0_0x5f14('0x76')](a0_0x5f14('0xa0'));
                this['$refs'][a0_0x5f14('0x15c')][a0_0x5f14('0x143')]();
            },
            'checkUserSubStatus': function() {
                if (this[a0_0x5f14('0x11c')] && this[a0_0x5f14('0x11c')][a0_0x5f14('0xc9')] && this[a0_0x5f14('0x11c')][a0_0x5f14('0xc9')][a0_0x5f14('0xeb')]) { if (this[a0_0x5f14('0x11c')][a0_0x5f14('0xc9')][a0_0x5f14('0xeb')] > 0x1) return this[a0_0x5f14('0xdf')] = !![], !![]; }
                this['is_customer'] = ![];
            },
            'showClassicWheelUpgrade': function(_0x492b8b) {
                if (this['user'] === null || !this[a0_0x5f14('0x11c')] || !this[a0_0x5f14('0x11c')]['id']) return this[a0_0x5f14('0x11')]['AuthModal'][a0_0x5f14('0x9c')](), this['show_upgrade_after_login'] = _0x492b8b, ![];
                var _0x125482 = this['$t'](a0_0x5f14('0x150')),
                    _0x48fa18 = this['$t'](a0_0x5f14('0x4')),
                    _0x48c745 = [this['$t'](a0_0x5f14('0x12c')), this['$t']('upgrade.classic_wheel.feature2'), this['$t'](a0_0x5f14('0x7c')), this['$t'](a0_0x5f14('0x9d')), this['$t'](a0_0x5f14('0x7a'))];
                this[a0_0x5f14('0x115')](0x0, _0x492b8b, 'classic-wheel', { 'custom_title': this['$t'](a0_0x5f14('0x107')), 'custom_text': this['$t'](a0_0x5f14('0xd5')), 'features_page': { 'title': _0x125482, 'text': _0x48fa18, 'features': _0x48c745 } });
            },
            'setAdvancedMode': function() {
                if (this[a0_0x5f14('0x3a')]['advanced_mode']) {
                    console[a0_0x5f14('0x13d')](a0_0x5f14('0x5b'), this[a0_0x5f14('0x5b')]);
                    var _0x3b19dd = this[a0_0x5f14('0x5b')]['split']('\x0a')[a0_0x5f14('0x68')](function(_0x4d4c67) { return _0x4d4c67 !== ''; })[a0_0x5f14('0x158')](function(_0x181bac) { return _0x181bac[a0_0x5f14('0xbd')](); });
                    this['wheel_add_option_list'] = [], _0x3b19dd['forEach'](_0x18b2d9 => { this['wheel_add_option_list'][a0_0x5f14('0x25')]({ 'text': _0x18b2d9, 'chance': -0x1, 'calculated_chance': 0x0, 'color': '' }); }), this['onPrizeChanceChange']();
                } else {
                    var _0x3b19dd = this[a0_0x5f14('0x11e')][a0_0x5f14('0x158')](function(_0x387bb1) { return _0x387bb1[a0_0x5f14('0x113')]; });
                    this[a0_0x5f14('0x5b')] = _0x3b19dd[a0_0x5f14('0x41')]('\x0a');
                }
            },
            'onPrizeInputChange': function() {
                var _0x264316 = this['wheel_add_option_list']['map'](function(_0x19a26d) { return _0x19a26d['text']; });
                this['participants'] = _0x264316, this[a0_0x5f14('0x6a')]();
            },
            'getPrizeChanceAvailable': function(_0x2bddbd) {
                var _0x505186 = 0x0;
                this[a0_0x5f14('0x11e')][a0_0x5f14('0x87')](function(_0x43603e) { _0x43603e[a0_0x5f14('0x133')] > -0x1 && (_0x505186 += parseInt(_0x43603e['chance'])); });
                let _0x17a1dd = 0x64 - _0x505186;
                debugger;
                return _0x2bddbd && _0x2bddbd['chance'] > 0x0 && (_0x17a1dd = _0x17a1dd + _0x2bddbd[a0_0x5f14('0x133')]), _0x17a1dd;
            },
            'onPrizeChanceChange': function() {
                var _0x445602 = this[a0_0x5f14('0x11e')][a0_0x5f14('0xaa')],
                    ...
                    _0x4ec296 = 0x0,
                    _0x567283 = 0x0;
                this['wheel_add_option_list'][a0_0x5f14('0x87')](function(_0xb26e85) { _0xb26e85[a0_0x5f14('0x133')] === -0x1 ? _0x10574b++ : (_0x26c519++, _0x567283 += parseInt(Math[a0_0x5f14('0x9e')](_0xb26e85[a0_0x5f14('0x133')]))); }), _0x4ec296 = (0x64 - _0x567283) / _0x10574b, _0x4ec296 < 0x0 && (_0x4ec296 = 0x0), this['wheel_add_option_list'][a0_0x5f14('0x87')](function(_0x317995) { _0x317995[a0_0x5f14('0x133')] === -0x1 ? _0x4ec296 > 0x0 ? _0x317995[a0_0x5f14('0xf7')] = Number(_0x4ec296[a0_0x5f14('0x4c')](0x1)) : _0x317995[a0_0x5f14('0xf7')] = _0x4ec296 : _0x317995['calculated_chance'] = _0x317995[a0_0x5f14('0x133')]; }), console['clear'](), console[a0_0x5f14('0x13d')](a0_0x5f14('0x86'), _0x445602), console[a0_0x5f14('0x13d')](a0_0x5f14('0xf2'), _0x4ec296), console[a0_0x5f14('0x13d')]('entries_with_custom_chance', _0x26c519), console[a0_0x5f14('0x13d')](a0_0x5f14('0x11d'), _0x567283);
            },
            'onDeleteEntry': function(_0x27aecc, _0x2ad383) { this[a0_0x5f14('0x11e')]['splice'](_0x2ad383, 0x1), this[a0_0x5f14('0x138')](), this['onPrizeChanceChange'](); },
            'onAddEntry': function() { this['wheel_add_option_list'][a0_0x5f14('0x25')]({ 'text': '', 'chance': -0x1, 'calculated_chance': 0x0, 'color': '' }), this['onPrizeInputChange'](), this[a0_0x5f14('0x126')](); },
            'onEditEntry': function(_0x3d8fed, _0x2a89fa) { this[a0_0x5f14('0x92')] = Object[a0_0x5f14('0x37')]({}, _0x3d8fed), this[a0_0x5f14('0x92')][a0_0x5f14('0x125')] = _0x2a89fa, this['edit_entry_modal'][a0_0x5f14('0x3c')] = this[a0_0x5f14('0x5d')](_0x3d8fed), $(a0_0x5f14('0x19'))['modal'](); },
            'onEditEntryChanceUpdated': function(_0x584b40) { console[a0_0x5f14('0x13d')](_0x584b40[a0_0x5f14('0x4e')]['value']); },
            'onEditEntryApplyChanges': function() {
                var _0xbbf557 = this[a0_0x5f14('0x11e')][this[a0_0x5f14('0x92')]['index']];
                _0xbbf557[a0_0x5f14('0x113')] = this[a0_0x5f14('0x92')]['text'], _0xbbf557[a0_0x5f14('0x133')] = parseInt(this[a0_0x5f14('0x92')]['chance']), this[a0_0x5f14('0x92')] = null, this['onPrizeChanceChange'](), $(a0_0x5f14('0x19'))[a0_0x5f14('0xc0')](a0_0x5f14('0xe0'));
            }
        }
    });