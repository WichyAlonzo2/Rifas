...
$jsonData = file_get_contents('../app/team.json');
...
<head>
    ...
    <title>Status <?php echo $infoSorteoNombre . ' - ' . $importanteNombreCorto?></title>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(".buttons__rad_team").click(function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "save_team.php", // Reemplaza con la URL de tu script PHP
                        data: {
                            clave: clave,
                            gol1: input1,
                            gol2: input2
