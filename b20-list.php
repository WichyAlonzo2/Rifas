...
$result = mysqli_query($db, "SELECT COUNT(statusBoleto) AS `count` FROM `$info_bol` WHERE statusBoleto='No'");
...
if ($countFree == 0) {
    ...
    $titleSort = $infoSorteoNombre . " - " . $importanteNombreCorto;
        ...
        <div class="container__datosD mt-5">
            <div class="container datos_stl">
                <section class="py-4 py-xl-5 container" style="padding: 13px!important;background: rgba(0,0,0,0);">
                    <h4 class="fs-4 text-center pt-3" style="color: rgb(255,255,255);"><strong><?php echo $infoSorteoDetallesBoletosSorteo; ?></strong></h4>
                </section>
            </div>
        </div>
        <section class="spremio__kpl py-4 py-xl-5" style="padding-bottom: 20px!important;">
            <h3 class="container fs-3 text__premioKprS text-center"><strong><span><?php echo $infoSorteoPremios; ?></span></h3>
        </section>
        <section>
