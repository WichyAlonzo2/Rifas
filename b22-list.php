...
$result = mysqli_query($db, "SELECT COUNT(statusBoleto) AS `count` FROM `$info_bolxx` WHERE statusBoleto='No'");
...
if ($countFree == 0) {
    ...
    $titleSort = $infoSorteoNombre3 . " - " . $importanteNombreCorto;
    ...
    if ($keySort === 1) { ?>
        ...
        <div class="container__datos">
            <div class="container datos_stl">
                <h1 class="text-center fs-1 text__premio"><strong><?php echo $infoSorteoNombre3; ?></strong></h1>
                <h3 class="text-center fs-3 text__premio"><strong><?php echo $infoSorteoTipo3; ?></strong></h3>
                <div id="chat"></div>
            </div>
        </div>
        <div>
        ...
        <div id="carouselExampleInterval" style="width: 80%;margin: auto;" class="carousel slide" data-bs-ride="carousel" data-bs-touch="false">
            <div class="carousel-inner img__premio">
                <div class="carousel-item active" data-bs-interval="2000">
                    <img src="assets/img/<?php echo $Portada2; ?>" class="img_premioX d-block w-100" alt="...">
                </div>
                <?php
        ...
        <div class="container__datosD mt-5">
            <div class="container datos_stl">
                <section class="py-4 py-xl-5 container" style="padding: 13px!important;background: rgba(0,0,0,0);">
                    <h4 class="fs-4 text-center pt-3" style="color: rgb(255,255,255);"><strong><?php echo $infoSorteoDetallesBoletosSorteo3; ?></strong></h4>
                </section>
            </div>
        </div>
        <section class="spremio__kpl py-4 py-xl-5" style="padding-bottom: 20px!important;">
            <h3 class="container fs-3 text__premioKprS text-center"><strong><span><?php echo $infoSorteoPremios3; ?></span></h3>
        </section>
        <section>
